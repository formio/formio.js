...
gulp.task('clean:embed-css', () =>
    gulp
        .src('./dist/formio.embed.css', { read: false, allowEmpty: true })
        .pipe(clean()),
);
gulp.task('embed-css', () =>
    gulp
...
gulp.task('clean:embed-js', () =>
    gulp
        .src('./dist/formio.embed.js', { read: false, allowEmpty: true })
        .pipe(clean()),
);
gulp.task('embed-js', () =>
    gulp
        .src('./dist/formio.embed.min.js')
...
gulp.task('timezones', () =>
    gulp
        .src('./node_modules/moment-timezone/data/packed/latest.json')
