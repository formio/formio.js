                ...
                if (component !== 'componentmodal') {
                    describe(`Component ${component}`, () => {
                        ...
                        it(`Renders ${component} for ${framework} as required`, (done) => {
                            ...
                            assert.equal(
                                renders[
                                    `component-${framework}-${component}-required`
                                ],
                                pretty(instance.render(), { ocd: true }),
                            );
                            done();
                        ...
                        it(`Renders ${component} for ${framework} as multiple`, (done) => {
                            ...
                            assert.equal(
                                renders[
                                    `component-${framework}-${component}-multiple`
                                ],
                                pretty(instance.render(), { ocd: true }),
                            );
                            done();
                        ...
                        if (
                            ...
                            const values =
                                require(`../${componentDir}/${component}/fixtures/values.js`).default.slice(
                                    0,
                                );
                            ...
                            values.forEach((value, index) => {
                                it(`Renders ${component} for ${framework} value ${index} as html`, (done) => {
                                    const instance = new AllComponents[
                                        component
                                    ](
                                        {},
                                        {
                                ...
                                it(`Renders ${component} for ${framework} value ${index} as string`, (done) => {
                                    ...
                                    const val =
                                        instance.getValueAsString(value);
