...
describe('Wizard tests', function () {
    it('Should recalculate values for components with "allow override" after wizard is canceled', function (done) {
        ...
        Formio.createForm(formElement, formsWithAllowOverride.wizard)
            .then((form) => {
    ...
    it('Should check correctly Permissions and disabled sumbit button', function (done) {
        ...
        wizard
            .setForm(wizardPermission)
            .then(() => {
                wizard.form.disableWizardSubmit = true;
                wizard.redraw();
                const btn = wizard.element.querySelector(
    ...
    it('Should correctly reset values', function (done) {
        ...
        wizard
            .setForm(wizardWithDataGridAndEditGrid)
            .then(() => {
                ...
                const checkComponents = (
                    ...
                    assert.equal(
                        ...
                        editGridRowsNumber,
                        `EditGrit should have ${dataGridRowsNumber} rows`,
                    );
                    assert.equal(
                        editGrid.components.length,
                        editGridRowsNumber,
                        `EditGrit should have ${dataGridRowsNumber} components`,
                    );
                    assert.equal(
                        dataGrid.rows.length,
                        dataGridRowsNumber,
                        `DataGrit should have ${dataGridRowsNumber} rows`,
                    );
                    assert.equal(
                        dataGrid.components.length,
                        dataGridRowsNumber,
                        `DataGrit should have ${dataGridRowsNumber} components`,
                    );
                    ...
                    if (editGridValue) {
                        assert.deepEqual(
                            editGrid.dataValue,
                            editGridValue,
                            'Should set correct editGrid value',
                        );
                    }
                    ...
                    if (dataGridValue) {
                        assert.deepEqual(
                            dataGrid.dataValue,
                            dataGridValue,
                            'Should set correct dataGrid value',
                        );
                    }
                };
                ...
                setTimeout(() => {
                    checkComponents(
                        2,
                        2,
                        submission.data.editGrid,
                        submission.data.dataGrid,
                    );
                    wizard.cancel(true);
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            const dataGridFirstRowInput =
                                dataGrid.element.querySelector(
                            ...
                            setTimeout(() => {
                                ...
                                setTimeout(() => {
                                    const editGridFirstRowInput =
                                        editGrid.element.querySelector(
                                            '[name="data[editGrid][1][textField]"]',
                                        );
                ...
                setTimeout(() => {
                    ...
                    const checkPage = (pageNumber) => {
                        assert.equal(
                            wizard.page,
                            pageNumber,
                            `Should open wizard page ${pageNumber + 1}`,
                        );
                    };
                    ...
                    assert.equal(
                        wizard.allPages.length,
                        5,
                        'Should have 5 pages',
                    );
                    assert.equal(
                        wizard.refs[`${wizard.wizardKey}-link`].length,
                        5,
                        'Should contain refs to breadcrumbs of parent and nested wizard',
                    );
                    ...
                    setTimeout(() => {
                        checkPage(1);
                        assert.equal(
                            wizard.refs[`${wizard.wizardKey}`].querySelectorAll(
                                '[ref="component"]',
                            ).length,
                            1,
                            'Should not load nested wizard component of the page of nested form if this page contains other components',
                        );
                        clickWizardBtn('next');
                        ...
                        setTimeout(() => {
                            ...
                            assert.equal(
                                wizard.refs[
                                    `${wizard.wizardKey}`
                                ].querySelectorAll('[ref="component"]').length,
                                4,
                                'Should render nested wizard first page components',
                            );
                            ...
                            setTimeout(() => {
                                checkPage(2);
                                assert.equal(
                                    wizard.errors.length,
                                    1,
                                    'Should show validation error for required field',
                                );
                                assert.equal(
                                    wizard.refs.errorRef.length,
                                    1,
                                ...
                                setTimeout(() => {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        assert.equal(
                                            !!wizard.refs[
                                                `${wizard.wizardKey}-submit`
                                            ],
                                            true,
                                            'Should have submit btn on the last page',
                                        );
                                        ...
                                        setTimeout(() => {
                                            ...
                                            assert.equal(
                                                wizard.errors.length,
                                                3,
                                                'Should trigger validation errors on submit',
                                            );
                                            assert.equal(
                                                wizard.refs.errorRef.length,
                                                3,
                                                'Should show alert with error on submit',
                                            );
                                            wizard
                                                .getComponent('select')
                                                .setValue('value1');
                                            setTimeout(() => {
                                                ...
                                                assert.equal(
                                                    wizard.errors.length,
                                                    2,
                                                    'Should remove validation error if a component is valid',
                                                );
                                                assert.equal(
                                                    wizard.refs.errorRef.length,
                                                    2,
                                                    'Should remove error from alert if component is valid',
                                                );
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        assert.deepEqual(
                            wizard.data,
                            submission.data,
                            'Should set wizard submission',
                        );
                        assert.deepEqual(
                            wizard.submission.data,
                            submission.data,
                            'Should get wizard submission data',
                        );
                        ...
                        wizard.everyComponent((comp) => {
                            ...
                            if (expectedValue !== 'no data') {
                                assert.deepEqual(
                                    comp.getValue(),
                                    expectedValue,
                                    `Should set value for ${comp.component.type} inside wizard`,
                                );
                                assert.deepEqual(
                                    comp.dataValue,
                                    expectedValue,
            ...
            .then(() => {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        assert.deepEqual(
                            !!wizard.refs[`${wizard.wizardKey}-submit`],
                            true,
                            'Should hav submit btn on the last page',
                        );
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                ...
                                assert.deepEqual(
                                    !!wizard.refs[`${wizard.wizardKey}-submit`],
                                    false,
                                    'Should not have submit btn ',
                                );
                                assert.equal(
                                    wizard.pages.length,
                                    5,
                                    'Should show conditional page',
                                );
                                assert.equal(
                                    wizard.allPages.length,
                                    5,
                                ...
                                assert.equal(
                                    wizard.refs[`${wizard.wizardKey}-link`]
                                        .length,
                                    5,
                                    'Should contain refs to breadcrumbs of visible conditional page',
                                );
                                ...
                                setTimeout(() => {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        setTimeout(() => {
                                            ...
                                            assert.equal(
                                                wizard.refs[
                                                    `${wizard.wizardKey}-link`
                                                ].length,
                                                4,
                                                'Should contain refs to breadcrumbs of visible pages',
                                            );
                                            assert.deepEqual(
                                                !!wizard.refs[
                                                    `${wizard.wizardKey}-submit`
                ...
                const checkValues = () => {
                    wizard.allPages[wizard.page].everyComponent((comp) => {
                        ...
                        if (!isParent) {
                            ...
                            const value = isInEditGrid
                                ? comp.parent.refs['editgrid-editGrid-row'][
                                      comp.rowIndex
                                  ].textContent.trim()
                                : comp.element.querySelector("[ref='value']")
                                      .textContent;
                            const expectedValue = _.get(
                                wizardTestForm.htmlModeValues,
                                comp.path,
                                'no data',
                            );
                            ...
                            assert.equal(
                                ...
                                expectedValue === 'true'
                                    ? 'True'
                                    : expectedValue,
                                `${comp.component.key}: should render value in html render mode`,
                            );
                        }
                    });
                };
    ...
    it('Should render values for prefix Components', function (done) {
        ...
        wizard
            ...
            .then(() => {
                ...
                wizard.submission = _.cloneDeep(
                    wizardWithPrefixComps.submission,
                );
    ...
    it('Should redirect to the correct page from the Error list', function (done) {
        ...
        wizard
            .setForm(wizardWithComponentsWithSameApi)
            .then(() => {
                const clickWizardBtn = (pathPart) => {
                    const [btnKey] = Object.keys(wizard.refs).filter(
                        (key) => key.indexOf(pathPart) !== -1,
                    );
        ...
        wizard
            ...
            .then(() => {
                ...
                setTimeout(() => {
                    checkPage(1);
                    assert.equal(
                        wizard.tooltips.length,
                        1,
                        'Should have tooltip after advanced logic execution',
                    );
                    assert.equal(
                        !!wizard.refs[`${wizard.wizardKey}-tooltip`][0],
                        true,
                        'Should render tooltip icon',
                    );
                    ...
                    setTimeout(() => {
                        checkPage(2);
                        assert.equal(
                            wizard.allPages[wizard.page].disabled,
                            true,
                            'Should disable page components after advanced logic execution',
                        );
                        done();
                    }, 200);
                }, 200);
    ...
    it('Should navigate next page according to advanced next page logic', function (done) {
        ...
        _.each(form.components, (comp, index) => {
            if (index === 0) {
                comp.nextPage =
                    "next = data.textField === 'page3' ? 'page3' : 'page2'";
            }
            if (index === 1) {
                comp.nextPage =
                    "next = data.container && data.container.select === 'value1' ? 'page1' : 'page3'";
            }
        });
        ...
        wizard
            ...
            .then(() => {
                ...
                const checkBreadcrumb = () => {
                    assert.equal(
                        _.get(wizard.refs, `${wizard.wizardKey}-link`).length,
                        0,
                        'Should not render wizard breadcrumb',
                    );
                };
        ...
        wizard
            ...
            .then(() => {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        checkPage(0);
                        wizard.setSubmission(
                            _.cloneDeep(wizardTestForm.submission),
                        );
        ...
        wizard
            ...
            .then(() => {
                ...
                setTimeout(() => {
                    assert.deepEqual(
                        wizard.data,
                        wizardTestForm.submission.data,
                        'Should set wizard submission',
                    );
                    assert.deepEqual(
                        wizard.submission.data,
        ...
        customizedWizard
            ...
            .then(() => {
                ...
                const checkBtns = (page) => {
                    assert.equal(
                        customizedWizard.page,
                        page,
                        `Should set page ${page + 1}`,
                    );
                    assert.equal(
                        !!customizedWizard.refs[
                            `${customizedWizard.wizardKey}-next`
                        ],
                        false,
                        'Should not render wizard next btn',
                    );
                    assert.equal(
                        !!customizedWizard.refs[
                            `${customizedWizard.wizardKey}-cancel`
                        ],
                        false,
                        'Should not render wizard cancel btn',
                    );
                    assert.equal(
                        !!customizedWizard.refs[
                            `${customizedWizard.wizardKey}-previous`
                        ],
                        false,
                        'Should not render wizard previous btn',
                    );
                };

                const navigatePage = (btnKey) => {
                    const customBtn =
                        customizedWizard.components[
                            customizedWizard.page
                        ].getComponent(btnKey).refs.button;
                    const clickEvent = new Event('click');
        ...
        customizedWizard
            ...
            .then(() => {
                const formio = new Formio(
                    'http://test.localhost/draftwizardpages',
                    {},
                );
                let number = 1;
                ...
                formio.makeRequest = (type, url, method, data) => {
                    assert.equal(
                        method,
                        expectedValues[number].method,
                        `Should send ${expectedValues[number].method} request`,
                    );
                    assert.equal(
                        data._id,
                        expectedValues[number].id,
                        `Submission data should ${
                            expectedValues[number].id ? '' : 'not'
                        } contain id of editted submission`,
                    );
                    assert.equal(
                        url.endsWith(expectedValues[number].urlEnd),
                        true,
                        `Request url should end with ${expectedValues[number].urlEnd}`,
                    );
                    assert.equal(
                        data.state,
                        expectedValues[number].state,
                        `Should set ${expectedValues[number].state} state for submission`,
                    );
                    _.each(expectedValues[number].data, function (value, key) {
                        assert.equal(
                            data.data[key],
                            value,
                            `${key} field should contain "${value}" value in submission object`,
                        );
                    });
                ...
                customizedWizard.on('goToNextPage', function () {
                    customizedWizard
                        .executeSubmit({ state: 'draft' })
                        .then(() => customizedWizard.nextPage());
                });
                customizedWizard.on('goToPrevPage', function () {
                    customizedWizard
                        .executeSubmit({ state: 'draft' })
                        .then(() => customizedWizard.prevPage());
                });
                ...
                const setPageCompValue = (compKey, value) => {
                    customizedWizard.components[customizedWizard.page]
                        .getComponent(compKey)
                        .setValue(value);
                };
            ...
            .then(() => {
                ...
                const checkInvalidComp = (compKey, highLight) => {
                    ...
                    assert.deepEqual(
                        !!comp.error,
                        true,
                        `${compKey}: should have error`,
                    );
                    assert.deepEqual(
                        comp.error.message,
                        `${comp.component.label} is required`,
                        `${compKey}: should have correct required validation message`,
                    );
                    assert.deepEqual(
                        comp.pristine,
                        false,
                        `${compKey}: should set pristine to false`,
                    );
                    assert.deepEqual(
                        comp.element.classList.contains(
                            `${
                                highLight ? 'formio-error-wrapper' : 'has-error'
                            }`,
                        ),
                        true,
                        `${compKey}: should set error class`,
                    );
                    assert.deepEqual(
                        comp.refs.messageContainer
                            ...
                            .textContent.trim(),
                        `${comp.component.label} is required`,
                        `${compKey}: should display error message`,
                    );
                };
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        assert.equal(
                            wizard.refs.errorRef.length,
                            wizard.errors.length,
                            'Should show alert with validation errors',
                        );
                        assert.equal(
                            !!wizard.element.querySelector('.alert-danger'),
                            true,
                            'Should have alert with validation errors',
                        );
                        ...
                        setTimeout(() => {
                            ...
                            assert.equal(
                                wizard.errors.length,
                                1,
                                'Should have page validation error',
                            );
                            assert.equal(
                                wizard.refs.errorRef.length,
                                3,
                                'Should keep alert with validation errors',
                            );
                            ...
                            setTimeout(() => {
                                ...
                                setTimeout(() => {
                                    ...
                                    assert.equal(
                                        wizard.errors.length,
                                        0,
                                        'Should not have page validation error',
                                    );
                                    assert.equal(
                                        wizard.refs.errorRef.length,
                                        2,
                                    ...
                                    setTimeout(() => {
                                        ...
                                        assert.equal(
                                            wizard.errors.length,
                                            2,
                                            'Should have wizard validation errors',
                                        );
                                        assert.equal(
                                            wizard.refs.errorRef.length,
                                            2,
                                        ...
                                        setTimeout(() => {
                                            assert.equal(
                                                wizard.errors.length,
                                                1,
                                                'Should have wizard validation error',
                                            );
                                            assert.equal(
                                                wizard.refs.errorRef.length,
                                                1,
                                            ...
                                            setTimeout(() => {
                                                ...
                                                setTimeout(() => {
                                                    ...
                                                    assert.equal(
                                                        ...
                                                        false,
                                                        'Should not have alert with validation errors',
                                                    );
                                                    clickWizardBtn('link[2]');
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                ...
                                assert.equal(
                                    !!wizard.refs.errorRef,
                                    false,
                                    'Should not have alert with validation error',
                                );
        ...
        wizard.setForm(wizardTestForm.form).then(() => {
            const checkPage = (page) => {
                assert.equal(
                    wizard.page,
                    page,
                    `Page ${page + 1} should be the current page`,
                );
            };

            Harness.clickElement(
                wizard,
                wizard.refs[`${wizard.wizardKey}-link`][2],
            );
            checkPage(2);
    ...
    it('Should correctly set values in HTML render mode', function (done) {
        ...
        formHTMLMode
            .setForm(wizardForHtmlModeTest.form)
            .then(() => {
                formHTMLMode.setSubmission(wizardForHtmlModeTest.submission);

                setTimeout(() => {
                    const numberValue =
                        formHTMLMode.element.querySelector(
                            '[ref="value"]',
                        ).textContent;
                    assert.equal(
                        +numberValue,
                        wizardForHtmlModeTest.submission.data.number,
                    );

                    const nextPageBtn =
                        formHTMLMode.refs[`${formHTMLMode.wizardKey}-next`];
                    const clickEvent = new Event('click');
                    ...
                    setTimeout(() => {
                        ...
                        assert.equal(
                            textValue,
                            wizardForHtmlModeTest.submission.data.textField,
                        );
    ...
    it('Should show tooltip for wizard pages', function (done) {
        ...
        wizardWithPageTooltip
            .setForm(wizardWithTooltip)
            .then(() => {
                const clickEvent = new Event('click');

                assert.equal(wizardWithPageTooltip.tooltips.length, 1);

                const pageTooltipIcon =
                    wizardWithPageTooltip.refs[
                        `${wizardWithPageTooltip.wizardKey}-tooltip`
                    ][0];
                ...
                setTimeout(() => {
                    const tooltipText =
                        wizardWithPageTooltip.element.querySelector(
                            '.tippy-content',
                        ).textContent;
                    assert.equal(
                        tooltipText,
                        wizardWithPageTooltip.currentPanel.tooltip,
                    );
    ...
    it('Should not clear wizard data when navigating between wizard pages with hidden panel', function (done) {
        ...
        formWithHiddenPage
            ...
            .then(() => {
                ...
                const page1Field = formWithHiddenPage.element.querySelector(
                    '[name="data[number]"]',
                );
                ...
                setTimeout(() => {
                    assert.equal(
                        formWithHiddenPage.element.querySelector(
                            '[name="data[number]"]',
                        ).value,
                        555,
                    );
                    ...
                    const nextPageBtn =
                        formWithHiddenPage.refs[
                            `${formWithHiddenPage.wizardKey}-next`
                        ];
                    nextPageBtn.dispatchEvent(clickEvent);
                    ...
                    setTimeout(() => {
                        ...
                        const prevPageBtn =
                            formWithHiddenPage.refs[
                                `${formWithHiddenPage.wizardKey}-previous`
                            ];
    ...
    it('Should show signature submission in HTML render mode', function (done) {
        ...
        formWithSignatureHTMLMode
            .setForm(formWithSignature.form)
            .then(() => {
                formWithSignatureHTMLMode.setSubmission(
                    formWithSignature.submission,
                );

                setTimeout(() => {
                    const signatureImage =
                        formWithSignatureHTMLMode.element.querySelector(
                            '[ref="signatureImage"]',
                        );
                    assert.equal(
                        signatureImage.src ===
                            formWithSignature.submission.data.signature,
                        true,
                    );
    ...
    it('Should display conditional page after setting submission', function (done) {
        ...
        wizardWithSimpleConditionalPage
            ...
            .then(() => {
                setTimeout(() => {
                    assert.equal(
                        wizardWithSimpleConditionalPage.pages.length,
                        1,
                    );
                    assert.equal(
                        wizardWithSimpleConditionalPage.components.length,
                        1,
                    );
                    ...
                    setTimeout(() => {
                        ...
                        assert.deepEqual(
                            wizardWithSimpleConditionalPage.data,
                            submissionData,
                        );
                        done();
                    }, 500);
    ...
    it('Should display submission data on page with custom conditional logic in readOnly', function (done) {
        ...
        wizardWithCustomConditionalPage
            .setForm(wizard5)
            .then(() => {
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        assert.equal(
                            wizardWithCustomConditionalPage.pages.length,
                            1,
                        );
                        assert.equal(
                            wizardWithCustomConditionalPage.components.length,
                            1,
                        );
                        ...
                        setTimeout(() => {
                            ...
                            assert.equal(
                                wizardWithCustomConditionalPage.components
                                    .length,
                                2,
                            );
                            assert.deepEqual(
                                wizardWithCustomConditionalPage.data,
                                submissionData,
                            );

                            const clickEvent = new Event('click');
                            const secondPageBtn =
                                wizardWithCustomConditionalPage.refs[
                                    `${wizardWithCustomConditionalPage.wizardKey}-link`
                                ][1];
                            ...
                            setTimeout(() => {
                                assert.equal(
                                    wizardWithCustomConditionalPage.page,
                                    1,
                                );

                                const numberComponent =
                                    wizardWithCustomConditionalPage.element.querySelector(
                                        '[name="data[number]"]',
                                    );
    ...
    it('Should show conditional wizard page', function (done) {
        ...
        wizardWithConditionalPage
            .setForm(wizard3)
            .then(() => {
                setTimeout(() => {
                    assert.equal(wizardWithConditionalPage.pages.length, 1);
                    assert.equal(
                        wizardWithConditionalPage.components.length,
                        1,
                    );

                    const inputEvent = new Event('input');
                    const numberComponent =
                        wizardWithConditionalPage.element.querySelector(
                            '[name="data[number]"]',
                        );
        ...
        wizard
            ...
            .then(() => {
                ...
                setTimeout(() => {
                    ...
                    assert.notEqual(
                        wizard.refs[`wizard-${wizard.id}-previous`],
                        null,
                    );
                    assert.equal(
                        wizard.refs[
    ...
    it('Should display editGrid submission data in readOnly mode', function (done) {
        ...
        wizardForm
            ...
            .then(() => {
                wizardForm.setValue({
                    data: { editGrid: [{ textField: '111' }], number: 222 },
                });
                setTimeout(() => {
                    assert.equal(
                        wizardForm.element.querySelector(
                            '[name="data[number]"]',
                        ).value,
                        '222',
                    );
                    ...
                    Harness.clickElement(
                        wizardForm,
                        wizardForm.refs[`${wizardForm.wizardKey}-link`][1],
                    );

                    setTimeout(() => {
                        assert.equal(wizardForm.page, 1);

                        const ditGridRowValue = wizardForm.element
    ...
    it('Should set components errors if they are after page was changed with navigation', function (done) {
        ...
        wizardForm
            ...
            .then(() => {
                ...
                Harness.clickElement(
                    wizardForm,
                    wizardForm.refs[`${wizardForm.wizardKey}-link`][2],
                );
                assert.equal(wizardForm.page, 2);
                setTimeout(() => {
                    Harness.clickElement(
                        wizardForm,
                        wizardForm.refs[`${wizardForm.wizardKey}-link`][0],
                    );
    ...
    it('Should leave errors for invalid fields after validation on next button and entering valid data in one of the fields', function (done) {
        ...
        wizardForm
            ...
            .then(() => {
                Harness.clickElement(
                    wizardForm,
                    wizardForm.refs[`${wizardForm.wizardKey}-next`],
                );
                setTimeout(() => {
                    ...
                    const inputA = formElement.querySelector(
                        'input[name="data[a]"]',
                    );
    ...
    it('Should keep values during validation that are conditionally visible', async function () {
        ...
        assert.equal(
            textField.visible,
            true,
            'Inner components of the 3rd page should be visible',
        );
        assert.equal(
            textField.parentVisible,
            true,
            "parentVisible of the 3rd page's child components should be equal to true",
        );
        ...
        assert.equal(
            form.data.c,
            'c',
            'Should keep the value of a conditionally visible page.',
        );
    });
    ...
    it('If allowPrevious is given, the breadcrumb bar should be clickable for visited tabs.', function (done) {
        ...
        wizardForm
            .setForm(wizardWithAllowPrevious)
            .then(() => {
                Harness.clickElement(
                    wizardForm,
                    wizardForm.refs[`${wizardForm.wizardKey}-link`][1],
                ...
                setTimeout(() => {
                    assert.equal(
                        wizardForm.page,
                        0,
                        'Should be disabled for unvisited tabs.',
                    );
                    Harness.clickElement(
                        wizardForm,
                        wizardForm.refs[`${wizardForm.wizardKey}-next`],
                    ...
                    setTimeout(() => {
                        assert.equal(
                            wizardForm.enabledIndex,
                            1,
                            'Should be clickable for visited tabs.',
                        );
                        done();
                    }, 100);
                }, 100);
    ...
    it('Should scroll to the top of the page when the page is changed', function (done) {
        ...
        wizardForm
            ...
            .then(() => {
                ...
                setTimeout(() => {
                    assert.equal(
                        wizardForm.refs[wizardForm.wizardKey].scrollTop,
                        0,
                        'The top edge of the page should be aligned to the top edge of the window',
                    );
                    done();
                }, 350);
            })
    ...
    it('Should show the actual page after re-rendering due to nested wizards.', function (done) {
        ...
        wizardForm = new Wizard(formElement);
        wizardForm
            .setForm(wizardWithNestedWizard)
            .then(() => {
                assert.equal(
                    wizardForm.element.querySelector('.wizard-page'),
                    wizardForm.allPages[0].components[0].element.parentNode,
                );
                done();
            })
            .catch(done);
            ...
            form.setForm(wizardWithConditionallyVisiblePage)
                .then(() => {
                    ...
                    assert.equal(
                        ...
                        3,
                        'Should show all the pages in header',
                    );
                    ...
                    setTimeout(() => {
                        ...
                        assert.equal(
                            page2.visible,
                            false,
                            'Should be hidden by logic',
                        );
                        assert.equal(
                            form.refs[`wizard-${form.id}-link`].length,
                            2,
                            'Should remove invisible pages from header',
                        );
                        done();
                    }, 300);
                })
                ...
                .then((form) => {
                    ...
                    setTimeout(() => {
                        const secondQuestionToOpenNestedFormRadio =
                            form.getComponent([
                                'secondQuestionToOpenNestedForm',
                            ]);
                        assert(
                            secondQuestionToOpenNestedFormRadio.visible,
                            'Should become visible',
                        );
                        secondQuestionToOpenNestedFormRadio.setValue(
                            'openChildForm',
                        );
                        ...
                        setTimeout(() => {
                            ...
                            nestedForm.subForm.components.forEach((comp) => {
                                assert.equal(
                                    comp.root,
                                    nestedForm.subForm,
                                    'The root of the nested components should be set to the' +
                                        ' Wizard itself',
                                );
                            });
                            const nestedRadio1 =
                                nestedForm.subForm.getComponent(['radio1']);

                            nestedRadio1.setValue('unhidePage3');

                            setTimeout(() => {
                                const pages = form.element.querySelectorAll(
                                    '.formio-form nav .pagination .page-item',
                                );
                                assert.equal(
                                    pages.length,
                                    3,
                                    'Should show the hidden initially page',
                                );
                                ...
                                setTimeout(() => {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        nestedForm.subForm.components.forEach(
                                            (comp) => {
                                                assert.equal(
                                                    comp.root,
                                                    nestedForm.subForm,
                                        ...
                                        const nestedRadio1 =
                                            nestedForm.subForm.getComponent([
                                                'radio1',
                                            ]);
    ...
    it('Should have proper values for localRoot', function (done) {
        ...
        wizard.setForm(form).then(() => {
            ...
            setTimeout(() => {
                ...
                const nestedChildFormComp =
                    middleWizard.getComponent('childForm');
                ...
                setTimeout(() => {
                    ...
                    assert.notEqual(
                        middleWizard.root.id,
                        middleWizard.localRoot.id,
                    );
    ...
    it("Should navigate wizard pages and submit form using 'Save on Enter' option", function (done) {
        ...
        wizard
            .setForm(wizardNavigateOrSaveOnEnter.form)
            .then(() => {
                const pressEnter = () => {
