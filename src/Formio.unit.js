	...
	describe('Formio.currentUser', function () {
		...
		it("Should render after form submission if renderMode = 'html'", function (done) {
			...
			Formio.createForm(element, formJson, {
				...
				.then((form) => {
					...
					assert.equal(
						textField.element.querySelector('[ref=value]').innerHTML,
						'-',
					);
					assert.equal(
						phoneNumber.element.querySelector('[ref=value]').innerHTML,
						'-',
					);
					form.submission = {
						data: {
		...
		it("Should render after form submission if renderMode = 'html' with Nested Form", function (done) {
			...
			Formio.createForm(element, formJson, {
				...
				.then((form) => {
					assert.equal(
						form.getComponent('textField').element.querySelector('[ref=value]')
							.innerHTML,
						'-',
					);
					assert.equal(
						form.getComponent('password').element.querySelector('[ref=value]')
							.innerHTML,
						'-',
					);
					form.submission = {
