...
export default [
  {
    ...
    validate: {
      custom:
        "valid = !data.enableTime && !input ? 'Cannot disable both Date and Time inputs at the same time' : true",
    },
  },
  {
    type: 'tags',
  ...
  },
  {
    ...
    components: [
      EditFormUtils.logicVariablesTable('<tr><th>date</th><td>The date object.</td></tr>'),
      {
        ...
        description:
          'For more information check out the <a href="https://flatpickr.js.org/examples/#disabling-dates" target="_blank" rel="noopener noreferrer">Docs</a>',
        weight: 22,
      },
      {
        type: 'htmlelement',
