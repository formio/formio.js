			...
			components: [
				...
				},
				{
					...
					components: [
						...
						{
							label:
								"Row Show - Show textfield when data grid radio has 'show' value",
							alwaysEnabled: false,
							tableView: true,
						...
						{
							label:
								"DG Calculated - Value should populate from 'root calculated text' field",
							tableView: true,
						...
						{
							label:
								'Textfield - Data should populate from Datagrid calculate field',
							alwaysEnabled: false,
							tableView: true,
