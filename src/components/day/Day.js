...
export default class DayComponent extends Field {
    ...
    get dayRequired() {
        return (
            this.showDay && _.get(this.component, 'fields.day.required', false)
        );
    }
    ...
    get monthRequired() {
        return (
            this.showMonth &&
            _.get(this.component, 'fields.month.required', false)
        );
    }
    ...
    get yearRequired() {
        return (
            this.showYear &&
            _.get(this.component, 'fields.year.required', false)
        );
    }
    ...
    get years() {
        ...
        const minYears =
            _.get(this.component, 'fields.year.minYear', 1900) || 1900;
        const maxYears =
            _.get(this.component, 'fields.year.maxYear', 2030) || 2030;
    ...
    getDate(value) {
        ...
        if (month === undefined || _.isNaN(month)) {
            month =
                defaults[MONTH] && !_.isNaN(defaults[MONTH])
                    ? defaults[MONTH]
                    : 0;
        }
