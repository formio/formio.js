    ...
    ltOrGt: {
      ...
      check(component, value) {
        ...
        if (component._widget.settings.maxDate && value.isValid()) {
          ...
          if (value > maxDate) {
            this.validators.calendar.messageText = `The entered date is greater than ${moment(component._widget.settings.maxDate).format(momentFormat)}`;
            return false;
          }
        }
        ...
        if (component._widget.settings.minDate && value.isValid()) {
          ...
          if (value < minDate) {
            this.validators.calendar.messageText = `The entered date is less than ${moment(component._widget.settings.minDate).format(momentFormat)}`;
            return false;
          }
        }
