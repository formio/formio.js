    ...
    attach(element) {
        ...
        this.refs.input.forEach((input, index) => {
            ...
            if (this.isRadio) {
                ...
                if (
                    this.isSelectURL &&
                    _.isObject(this.loadedOptions[index].value)
                ) {
        ...
        if (element && this.refs.input) {
            this.refs.input.forEach((input, index) => {
                if (this.component.values[index]) {
                    this.removeShortcut(
                        input,
                        this.component.values[index].shortcut,
                    );
                }
            });
        }
    ...
    validateValueProperty() {
        ...
        return !_.some(
            ...
            (wrapper, index) =>
                ...
                this.loadedOptions[index].invalid,
        );
    }
    ...
    loadItemsFromMetadata() {
        this.listData.forEach((item, i) => {
            ...
            if (
                _.isEqual(
                    item,
                    this.selectData || _.pick(this.dataValue, _.keys(item)),
                )
            ) {
        ...
        items?.forEach((item, i) => {
            ...
            if (
                ...
                (_.isUndefined(item[this.component.valueProperty]) ||
                    ...
                    (!this.isRadio &&
                        _.isBoolean(item[this.component.valueProperty])))
            ) {
