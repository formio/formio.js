...
describe('EditGrid Component', function () {
    it('Should set correct values in dataMap inside editGrid and allow aditing them', function (done) {
        Harness.testCreate(EditGridComponent, comp4).then((component) => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    const keyValue =
                        component.element.querySelectorAll('[ref="input"]')[0]
                            .value;
                    const valueValue =
                        component.element.querySelectorAll('[ref="input"]')[1]
                            .value;
    ...
    it('Should set correct values after reset', function (done) {
        Harness.testCreate(EditGridComponent, comp5).then((component) => {
            ...
            component.setValue(
                [{ textField: 'textField1' }, { textField: 'textField2' }],
                { resetValue: true },
            );
    ...
    it('Should build an empty edit grid component', function () {
        return Harness.testCreate(EditGridComponent, comp1).then(
            (component) => {
                Harness.testInnerHtml(
                    component,
                    'li.list-group-header div.row div:nth-child(1)',
                    'Field 1',
                );
                Harness.testInnerHtml(
                    component,
                    'li.list-group-header div.row div:nth-child(2)',
                    'Field 2',
                );
                Harness.testInnerHtml(
                    component,
                ...
                assert.equal(
                    component.refs[`${component.editgridKey}-addRow`].length,
                    1,
                );
                assert(
        ...
        return Harness.testCreate(EditGridComponent, comp1).then(
            (component) => {
                ...
                Harness.clickElement(
                    component,
                    component.refs[`${component.editgridKey}-addRow`][0],
                );
                ...
                assert(
                    !component.checkValidity(component.getValue(), true),
                    'Item should not be valid',
                );
            },
        );
    });
        ...
        return Harness.testCreate(EditGridComponent, comp1).then(
            (component) => {
                ...
                Harness.setInputValue(
                    component,
                    'data[editgrid][2][field1]',
                    'good',
                );
                Harness.setInputValue(
                    component,
                    'data[editgrid][2][field2]',
                    'baz',
                );
                Harness.clickElement(
                    component,
                    'div.editgrid-actions button.btn-primary',
                );
                Harness.testElements(component, 'li.list-group-item', 4);
                Harness.testInnerHtml(
                    component,
    ...
    it('Should cancel add a row when cancel is clicked', function () {
        return Harness.testCreate(EditGridComponent, comp1).then(
            (component) => {
                ...
                Harness.clickElement(
                    component,
                    'div.editgrid-actions button.btn-danger',
                );
                Harness.testElements(component, 'li.list-group-item', 3);
                Harness.testInnerHtml(
                    component,
    ...
    it('Should delete a row when delete is clicked', function () {
        return Harness.testCreate(EditGridComponent, comp1).then(
            (component) => {
                ...
                Harness.clickElement(
                    component,
                    'li.list-group-item:nth-child(3) div.removeRow',
                );
                Harness.testInnerHtml(
                    component,
                    'li.list-group-header div.row div:nth-child(3)',
    ...
    it('Should edit a row when edit is clicked', function () {
        return Harness.testCreate(EditGridComponent, comp1).then(
            (component) => {
                ...
                Harness.clickElement(
                    component,
                    'li.list-group-item:nth-child(3) div.editRow',
                );
                Harness.getInputValue(
                    component,
                    'data[editgrid][1][field1]',
                    'good',
                );
                Harness.getInputValue(
                    component,
                    'data[editgrid][1][field2]',
                    'bar',
                );
    ...
    it('Should not allow saving when errors exist', function () {
        return Harness.testCreate(EditGridComponent, comp1).then(
            (component) => {
                ...
                Harness.getInputValue(
                    component,
                    'data[editgrid][0][field1]',
                    '',
                );
                Harness.getInputValue(
                    component,
                    'data[editgrid][0][field2]',
                    '',
                );
                assert(
                    !component.checkValidity(component.getValue(), true),
    ...
    it('Should disable components when in read only', function () {
        return Harness.testCreate(EditGridComponent, comp1, {
            readOnly: true,
        }).then((component) => {
            Harness.testSetGet(component, [
                {
    ...
    describe('Display As Modal', function () {
        it('Should show add error classes to invalid components', function (done) {
            ...
            form.setForm(displayAsModalEditGrid)
                .then(() => {
                    ...
                    setTimeout(() => {
                        ...
                        const saveButton =
                            dialog.querySelector('.btn.btn-primary');
                        saveButton.dispatchEvent(clickEvent);
                        setTimeout(() => {
                            assert.equal(editGrid.errors.length, 6);
                            const components = Array.from(
                                dialog.querySelectorAll('[ref="component"]'),
                            );
                            const areRequiredComponentsHaveErrorWrapper =
                            ...
                            assert.equal(
                                areRequiredComponentsHaveErrorWrapper,
                                true,
                            );
                ...
                .then(() => {
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            const textField =
                                editRow.components[0].getComponent('textField');
                            textField.setValue('new value');

                            setTimeout(() => {
                                const alertAfterFixingField =
                                    dialog.querySelector('.alert.alert-danger');
                                assert.equal(form.errors.length, 2);

                                const errorsLinksAfterFixingField =
                                    alertAfterFixingField.querySelectorAll(
                                        'li',
                                    );
                                assert.equal(
                                    errorsLinksAfterFixingField.length,
                                    1,
                                );
        ...
        it('Confirmation dialog', function (done) {
            ...
            form.setForm(comp6)
                .then(() => {
                    ...
                    assert(
                        confirmationDialog,
                        'Should open a confirmation dialog when trying to close',
                    );
                    Harness.dispatchEvent(
                        'click',
                        confirmationDialog,
                    ...
                    setTimeout(() => {
                        assert.equal(
                            component.editRows[0].data.textField,
                            '12',
                        ...
                        setTimeout(() => {
                            const confirmationDialog2 = document.querySelector(
                                '[ref="confirmationDialog"]',
                            );
                            assert(
                                confirmationDialog2,
                                'Should open again a conformation dialog',
                            );
                            Harness.dispatchEvent(
                                'click',
                                confirmationDialog2,
        ...
        it('Should not produce many components in Edit view when minLength validation set', function (done) {
            ...
            Formio.createForm(formElement, comp15, { attachMode: 'builder' })
                .then((form) => {
                    const editGrid = form.components[0];
                    const elements =
                        editGrid.element.querySelectorAll('[ref="input"]');
    ...
    describe('Draft Rows', function () {
        it('Check saving rows as draft', function (done) {
            Harness.testCreate(EditGridComponent, comp5)
                .then((component) => {
                    ...
                    Harness.clickElement(
                        component,
                        '[ref="editgrid-editGrid1-saveRow"]',
                    );
                    assert.deepEqual(component.dataValue, [{ textField: '' }]);
                    const isInvalid = !component.checkValidity(
                        component.dataValue,
                        true,
                    );
                                    ...
                                    setTimeout(() => {
                                        ...
                                        setTimeout(() => {
                                            editGrid.editRow(0).then(() => {
                                                ...
                                                setTimeout(() => {
                                                    const errorAlert =
                                                        editGrid.editRows[0].dialog.querySelector(
                                                            `#error-list-${editGrid.id}`,
                                                        );
                                                    const hasError =
                                                        textField.className.includes(
                                                            'has-error',
                                                        );
                                                    assert(
                                                        !hasError,
                                                        'Should stay valid until form is submitted',
                                                    );
                                                    assert.equal(
                                                        errorAlert,
                                                        null,
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            assert.equal(
                                form.errors.length,
                                0,
                                'Should not add new errors when drafts are enabled',
                            );
                            assert(
                                !alert,
                                ...
                                setTimeout(() => {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        assert.equal(
                                            ...
                                            0,
                                            'Should not add error to components inside draft row',
                                        );

                                        const textFieldComponent =
                                            textField.element;
                                        assert(
                                            textFieldComponent.className.includes(
                                                'has-error',
                                            ),
        ...
        it('Should keep fields valid inside NestedForms if drafts are enabled part two', function (done) {
            const formElement = document.createElement('div');
            const form = new Webform(formElement);
            ModalEditGrid.components[0].rowDrafts = true;
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                ...
                                assert.equal(
                                    editGrid.editRows[0].errors.length,
                                    2,
                                    'Should dd errors to the row after an attempt to submit',
                                );
                                ...
                                setTimeout(() => {
                                    ...
                                    assert(
                                        editRow.alerts,
                                        'Should add an error alert to the modal',
                                    );
                                    assert.equal(
                                        editRow.errors.length,
                                        2,
                                        'Should add errors to components inside draft row aftre it was submitted',
                                    );
                                    const textField =
                                        editRow.components[0].getComponent(
                                            'textField',
                                        );
                                    ...
                                    assert(
                                        textField.element.className.includes(
                                            'has-error',
                                        ),
                                    ...
                                    setTimeout(() => {
                                        ...
                                        assert(
                                            !textFieldEl.className.includes(
                                                'has-error',
                                            ),
                                        ...
                                        setTimeout(() => {
                                            assert.equal(
                                                textField2.dataValue,
                                                'test val',
                                            );
                                            assert(
                                                !textField2.element.className.includes(
                                                    'has-error',
                                                ),
                                                'Should remove an error class from component when it was fixed',
                                            );
                                            ...
                                            setTimeout(() => {
                                                ...
                                                const rows =
                                                    editGrid.element.querySelectorAll(
                                                        '[ref="editgrid-editGrid-row"]',
                                                    );
                                                const firstRow = rows[0];
                                                Harness.dispatchEvent(
    ...
    it("Test simple conditions based on the EditGrid's child's value and default values when adding rows", function (done) {
        const formElement = document.createElement('div');
        const form = new Webform(formElement);
        form.setForm({ display: 'form', components: [comp7], type: 'form' })
            .then(() => {
                ...
                setTimeout(() => {
                    Harness.getInputValue(
                        component,
                        'data[editGrid][0][checkbox]',
                        true,
                        'checked',
                    );
                    Harness.testComponentVisibility(
                        component,
                        '.formio-component-editGridChild',
                        true,
                    );
                    Harness.testComponentVisibility(
                        component,
                        '.formio-component-panelChild',
                        true,
                    );
                    done();
                }, 250);
                ...
                setTimeout(() => {
                    ...
                    editGrid.editRow(0).then(() => {
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                assert(
                                    !form.data.editGrid[0].editGridChild,
                                    'Should be cleared',
                                );
                                assert(
                                    !form.data.editGrid[0].panelChild,
                                    'Should be cleared',
                                );
                                done();
                            }, 150);
    ...
    it('Test refreshing inside EditGrid', function (done) {
        const formElement = document.createElement('div');
        const form = new Webform(formElement);
        form.setForm({ display: 'form', components: [comp8], type: 'form' })
            .then(() => {
            ...
            .then(() => {
                ...
                const checkRows = (columnsNumber, rowsNumber) => {
                    const rowWithColumns =
                        editGrid.element.querySelector('.row');
                    const rowsWithValues = editGrid.element.querySelectorAll(
                        '[ref="editgrid-editGrid-row"]',
                    );
                    ...
                    assert.equal(
                        ...
                        rowsNumber,
                        'Should have corrent number of rows',
                    );
                };
        ...
        form.setForm(comp9)
            .then(() => {
                ...
                const checkHeader = (componentsNumber) => {
                    const header = editGrid.element
                        .querySelector('.list-group-header')
                        .querySelector('.row');

                    assert.equal(
                        editGrid.visibleInHeader.length,
                        componentsNumber,
                    );
                ...
                const clickAddRow = () => {
                    const addAnotherBtn =
                        editGrid.refs['editgrid-editGrid-addRow'][0];
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        checkHeader(2);
                        assert.equal(
                            editGrid.getComponent('textArea')[0].visible,
                            true,
                        );
                        clickAddRow();
                        ...
                        setTimeout(() => {
                            ...
                            checkHeader(2);
                            const saveFirstRowBtn =
                                editGrid.refs['editgrid-editGrid-saveRow'][0];
                            clickElem(saveFirstRowBtn);

                            setTimeout(() => {
                                assert.equal(
                                    editGrid.editRows[0].state,
                                    'saved',
                                );
                                checkHeader(3);
        ...
        Formio.createForm(element, form)
            .then((form) => {
                ...
                const click = (btn, index, selector) => {
                    ...
                    if (selector) {
                        elem = editGrid.element.querySelectorAll(`.${btn}`)[
                            index
                        ];
                    } else {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                assert.equal(
                                    editGrid.refs['editgrid-editGrid-row']
                                        .length,
                                    1,
                                    'Should have 1 row',
                                );
                                ...
                                assert.equal(
                                    editGrid.editRows[0].state,
                                    'editing',
                                    'Should have state "editing"',
                                );
                                editGrid.editRows[0].components.forEach(
                                    (comp) => {
                                        comp.setValue(22222);
                                    },
                                );
    ...
    it('Should use custom text for save/cancel/add btns', function (done) {
        ...
        Formio.createForm(element, form)
            .then((form) => {
                ...
                assert.equal(
                    editGrid.refs[
                        'editgrid-editGrid-addRow'
                    ][0].textContent.trim(),
                    'add custom',
                );
                const clickEvent = new Event('click');
                editGrid.refs['editgrid-editGrid-addRow'][0].dispatchEvent(
                    clickEvent,
                );
                ...
                setTimeout(() => {
                    assert.equal(
                        editGrid.refs[
                            'editgrid-editGrid-saveRow'
                        ][0].textContent.trim(),
                        'save custom',
                    );
                    assert.equal(
                        editGrid.refs[
                            'editgrid-editGrid-cancelRow'
                        ][0].textContent.trim(),
                        'cancel custom',
                    );
    ...
    it('Should render headers when openWhenEmpry is enabled', function (done) {
        ...
        Formio.createForm(element, form)
            .then((form) => {
                ...
                const headerEls =
                    editGrid.element.querySelector('.list-group-header')
    ...
    it('Should keep value for conditional editGrid on setValue when server option is provided', function (done) {
        ...
        Formio.createForm(element, formsWithEditGridAndConditions.form1, {
            server: true,
        })
            .then((form) => {
                const formData = {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        const conditionalEditGrid =
                            editGrid1.getComponent('editGrid')[0];
    ...
    it('Should keep value for conditional editGrid in tabs on setValue when server option is provided', function (done) {
        ...
        Formio.createForm(element, formsWithEditGridAndConditions.form3, {
            server: true,
        })
            .then((form) => {
                const formData = {
    ...
    it('Should calculate editGrid value when calculateOnServer is enabled and server option is passed', function (done) {
        ...
        Formio.createForm(element, formsWithEditGridAndConditions.form4, {
            server: true,
        })
            .then((form) => {
                const editGrid = form.getComponent('editGrid');
    ...
    it('Should keep value for conditional editGrid deeply nested in panels and containers on setValue when server option is provided', function (done) {
        ...
        Formio.createForm(element, formsWithEditGridAndConditions.form5, {
            server: true,
        })
            .then((form) => {
                const formData = {
...
describe('EditGrid Open when Empty', function () {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            const textField =
                                editGrid.editRows[0].components[0];
                            assert.equal(
                                textField.dataValue,
                                '',
                            ...
                            setTimeout(() => {
                                ...
                                assert.equal(
                                    editGrid.editRows[0].state === 'saved',
                                    1,
                                    'Row should be saved',
                                );
    ...
    it('Should submit form with empty rows when submit button is pressed and no rows are saved', function (done) {
        ...
        form.setForm(compOpenWhenEmpty)
            .then(() => {
                const editGrid = form.components[0];
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        assert(
                            !editGrid.error,
                            'Should be no errors on EditGrid',
                        );
                        assert.equal(
                            editRow.errors,
                            null,
                            'Should not be any errors on open row',
                        );
                        assert.equal(
    ...
    it('Should not submit form if any row inputs are set as required', function (done) {
        ...
        form.setForm(EditGridOpenWhenEmpty)
            .then(() => {
                const editGrid = form.components[0];
