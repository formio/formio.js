...
export default class ButtonComponent extends Field {
    ...
    get inputInfo() {
        ...
        info.type = 'button';
        info.attr.type = ['submit', 'saveState'].includes(this.component.action)
            ? 'submit'
            : 'button';
    ...
    attachButton() {
        ...
        if (this.component.action === 'submit') {
            ...
            this.on(
                ...
                (message) => {
                    ...
                    this.addClass(
                        this.refs.button,
                        'btn-success submit-success',
                    );
                    this.removeClass(
                        this.refs.button,
                        'btn-danger submit-fail',
                    );
                    this.addClass(
                        this.refs.buttonMessageContainer,
                        'has-success',
                    );
                    this.removeClass(
                        this.refs.buttonMessageContainer,
        ...
        this.on(
            ...
            (value, flags) => {
                ...
                this.isDisabledOnInvalid =
                    this.component.disableOnInvalid && (isSilent || !isValid);
        ...
        this.addEventListener(this.refs.buttonMessageContainer, 'click', () => {
            if (
                this.refs.buttonMessageContainer.classList.contains('has-error')
            ) {
    ...
    get shouldDisabled() {
        return (
            super.shouldDisabled ||
            !!this.filesUploading?.length ||
            this.isDisabledOnInvalid
        );
    }
    ...
    onClick(event) {
        ...
        if (
            ...
            this.component.showValidations
        ) {
        ...
        switch (this.component.action) {
            ...
            case 'event':
                ...
                this.events.emit(
                    this.interpolate(this.component.event),
                    this.data,
                );
        ...
        let params = {
            ...
            redirect_uri:
                (settings.redirectURI &&
                    this.interpolate(settings.redirectURI)) ||
            ...
            try {
                ...
                if (popup && !popup.closed && popupHost === currentHost) {
                    ...
                    if (
                        ...
                        // Needs for the exclude oAuth Actions that not related to this button
                        submission.oauth[settings.provider].triggeredBy =
                            this.oauthComponentPath;
                        requestPromise =
    ...
    triggerReCaptcha() {
        ...
        this.root.everyComponent((component) => {
            if (
                component.component.type === 'recaptcha' &&
