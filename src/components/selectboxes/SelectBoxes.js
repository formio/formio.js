...
export default class SelectBoxesComponent extends RadioComponent {
    ...
    static get builderInfo() {
        return {
            ...
            weight: 60,
            documentation:
                '/userguide/form-building/form-components#select-box',
        ...
        return {
            ...
            valueComponent(classComp) {
                return {
                    ...
                    data: {
                        custom: `values = ${
                            classComp && classComp.values
                                ? JSON.stringify(classComp.values)
                                : []
                        }`,
                    },
                };
    ...
    normalizeValue(value) {
        ...
        if (
            ...
            checkedValues.forEach((value) =>
                selectData.push(this.templateData[value]),
            );
            ...
            this.refs.wrapper.forEach((wrapper, index) => {
                ...
                if (
                    ...
                    (this.isSelectURL &&
                        !this.shouldLoad &&
                        this.listData &&
                        _.findIndex(this.selectData, this.listData[index]) !==
                            -1)
                ) {
    ...
    checkComponentValidity(data, dirty, rowData, options) {
        ...
        if (!this.shouldSkipValidation(data, dirty, rowData)) {
            ...
            if (maxCount || minCount) {
                const count = Object.keys(this.validationValue).reduce(
                    (total, key) => {
    ...
    validateValueAvailability(setting, value) {
        ...
        const availableValueKeys = (values || []).map(
