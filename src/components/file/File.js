    ...
    upload(files) {
        ...
        if (this.component.storage && files && files.length) {
            ...
            Array.prototype.forEach.call(files, async (file) => {
                ...
                const fileWithSameNameUploading = this.filesUploading.some(
                    (fileUploading) => fileUploading === file.name,
                );
                ...
                if (fileUpload.status !== 'error') {
                    ...
                    this.filesUploading.splice(
                        this.filesUploading.indexOf(file.name),
                        1,
                    );
                }
            });
