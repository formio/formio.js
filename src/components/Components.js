...
export default class Components {
    ...
    static create(component, options, data) {
        ...
        if (
            component.type &&
            Components.components.hasOwnProperty(component.type)
        ) {
            comp = new Components.components[component.type](
                component,
                options,
                data,
            );
            ...
            comp = new Components.components['datagrid'](
                component,
                options,
                data,
            );
            ...
            // eslint-disable-next-line new-cap
            comp = new Components.components['nesteddata'](
                component,
                options,
                data,
            );
            ...
            // eslint-disable-next-line new-cap
            comp = new Components.components['nested'](
                component,
                options,
                data,
            );
            ...
            // eslint-disable-next-line new-cap
            comp = new Components.components['hidden'](
                component,
                options,
                data,
            );
