...
export default class TextAreaComponent extends TextFieldComponent {
            ...
            .then((quill) => {
              ...
              quill.setContents(
                quill.clipboard.convert({
                  html: this.setConvertedValue(dataValue, index),
                }),
              );
              editorReady(quill);
              return quill;
        ...
        case 'ckeditor':
          ...
          this.addCKE(element, settings, (newValue) =>
            ...
            if (getBrowserInfo().ie) {
              ...
              if (
                _.isFinite(numRows) &&
                _.has(editor, 'ui.view.editable.editableElement')
              ) {
  ...
  get htmlView() {
    return (
      this.options.readOnly && (this.component.editor || this.component.wysiwyg)
    );
  }
