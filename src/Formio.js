...
Formio.prototype.uploadFile = function(storage, file, fileName, dir, progressCallback, url, options, fileKey, groupPermissions, groupId, uploadStartCallback, abortCallback, multipart) {
  const requestArgs = {
    provider: storage,
    method: 'upload',
    file: file,
        ...
        .then((result) => {
          if (storage && isNil(result)) {
            ...
            if (Provider) {
              ...
              return provider.uploadFile(file, fileName, dir, progressCallback, url, options, fileKey, groupPermissions, groupId, abortCallback, multipart);
            }
            else {
