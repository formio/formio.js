...
export function findComponents(components, query) {
    console.warn(
        'formio.js/utils findComponents is deprecated. Use searchComponents instead.',
    );
...
export function findComponent(components, key, path, fn) {
    ...
    components.forEach(function (component, index) {
        ...
        if (
            Object.prototype.hasOwnProperty.call(component, 'columns') &&
        ...
        if (
            Object.prototype.hasOwnProperty.call(component, 'rows') &&
        ...
        if (
            Object.prototype.hasOwnProperty.call(component, 'components') &&
        ...
        component.customConditional ||
            (component.conditional &&
                (component.conditional.when ||
                    _.some(
                        component.conditional.conditions || [],
                        (condition) =>
                            condition.component && condition.operator,
                    ) ||
...
export function parseFloatExt(value) {
    return parseFloat(
        isString(value) ? value.replace(/[^\de.+-]/gi, '') : value,
    );
}
    ...
    eachComponent(
        ...
        (component) => {
            ...
            if (
                ...
                Object.prototype.hasOwnProperty.call(component, 'values') &&
