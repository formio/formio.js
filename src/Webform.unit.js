...
import NestedFormWithConditionals from '../test/forms/nestedFormWithConditionals.json';
...
import calculateValueWithManualOverrideLableValueDataGrid
  from '../test/forms/calculateValueWithManualOverrideLableValueDataGrid.js';
import deeplyNestedDataGridAndContainer from '../test/forms/nestedDataGridsAndContainers.js';
import columnWithConditionalComponents from '../test/forms/columnWithConditionalComponents.js';
import formWithSurvey from '../test/forms/formWithSurvey.js';
import formWithSelectBoxes from '../test/forms/formWithSelectBoxes.js';
import formWithDayComp from '../test/forms/formWithDayComp.js';
import formWithCalcValue from '../test/forms/formWithCalcValue.js';
import formWithAllowCalculateOverride from '../test/forms/formWithAllowCalculateOverride.js';
import testClearOnHideInsideEditGrid from '../test/forms/clearOnHideInsideEditGrid.js';
import formWithNestedDataGridInitEmpty from '../test/forms/nestedDataGridWithInitEmpty.js';
import formWithEventLogicInHiddenComponent from '../test/forms/formWithEventLogicInHiddenComponent.js';
import * as FormioUtils from './utils/utils.js';
import htmlRenderMode from '../test/forms/htmlRenderMode.js';
import optionalSanitize from '../test/forms/optionalSanitize.js';
import formsWithNewSimpleConditions from '../test/forms/formsWithNewSimpleConditions.js';
import formWithRadioInsideDataGrid from '../test/forms/formWithRadioInsideDataGrid.js';
import formWithCheckboxRadioType from '../test/forms/formWithCheckboxRadioType.js';
import formWithCheckboxRadioTypeAndValidation from '../test/forms/formWithCheckboxRadioTypeAndValidation.js';
import formWithFormController from '../test/forms/formWithFormController.js';
import calculateValueOnServerForEditGrid from '../test/forms/calculateValueOnServerForEditGrid.js';
import formsWithAllowOverride from '../test/forms/formsWithAllowOverrideComps.js';
import formWithDeeplyNestedConditionalComps from '../test/forms/formWithDeeplyNestedConditionalComps.js';
import formWithValidation from '../test/forms/formWithValidation.js';
import formWithNotAllowedTags from '../test/forms/formWithNotAllowedTags.js';
import formWithValidateWhenHidden from '../test/forms/formWithValidateWhenHidden.js';
import formWithEditGrid from '../test/forms/formWithEditGrid.js';
import formWithSelectRadioUrlDataSource from '../test/forms/selectRadioUrlDataSource.js';
...
import formWithUniqueValidation from '../test/forms/formWithUniqueValidation.js';
import formWithConditionalEmail from '../test/forms/formWithConditionalEmail.js';
import formsWithSimpleConditionals from '../test/forms/formsWithSimpleConditionals.js';
import translationErrorMessages from '../test/forms/translationErrorMessages.js';
