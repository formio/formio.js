          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                assert.equal(number.visible, true, 1111);
                assert.equal(textField.visible, true, 2222);
                assert.equal(textArea.visible, true, 333);
                assert.equal(radio.visible, true, 444);
