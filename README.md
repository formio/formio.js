...
![Image of Form.io Example Form](https://api.monosnap.com/file/download?id=iOZ1yB0wPntJLWQwyhdt7ucToLHEfF)
...
The determiniation on whether it should render as a wizard or not is based on the **display** property of the form schema being set to ```wizard```.
