...
## 3.29.16
### Changed
 - Added a way to force focus on an element.
...
## 3.29.14
### Fixed
 - Problem with setting root in the lazy loaded form components.

## 3.29.13
### Added
 - Ability to lazy render the nested form components.
...
## 3.29.10
### Fixed
 - An issue where text area with wysiwyg was erroneously firing change events.
...
## 3.29.7
### Fixed
 - Update logic to show image/canvas for logic

## 3.29.6
### Fixed
 - Nested clear on hide fix

## 3.29.5
### Fixed
 - Problems where erroneous change events would fire in text areas.
