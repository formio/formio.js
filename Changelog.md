...
### 4.12.7-patch.12
#### Fixed
 - Do not perform validations on non-input components.
...
### 4.12.7-patch.9
#### Fixed
 - Fixes an issue where modified flag is set to true when data is automatically set from the submission
...
### 4.12.7-patch.2
#### Fixed
 - FIO-1300: Fix: fix rendering of nested wizards
