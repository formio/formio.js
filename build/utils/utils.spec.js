...
describe('checkTrigger', function () {
  it('should default to false', function () {
    (0, _chai.expect)(_index2.default.checkCondition({}, { type: 'none' }, null, {})).to.be.equal(true);
  });
  ...
  it('should calculate simple triggers', function () {
    ...
    var data1 = { test: 3 };
    var data2 = { test: 5 };
    (0, _chai.expect)(_index2.default.checkTrigger(component, trigger, null, data1)).to.be.equal(true);
    (0, _chai.expect)(_index2.default.checkTrigger(component, trigger, null, data2)).to.be.equal(false);
  });
...
describe('setActionProperty', function () {
  it('should set a boolean action property to true', function () {
    ...
    _index2.default.setActionProperty(component, action, {}, {}, true);
  ...
  it('should set a string action property with row templating', function () {
    ...
    _index2.default.setActionProperty(component, action, { field: 'baz' }, {}, true);
  ...
  it('should set a string action property with result templating', function () {
    ...
    _index2.default.setActionProperty(component, action, {}, {}, 'baz');
    (0, _chai.expect)(component.label).to.be.equal('bar baz');
  });
  ...
  it('should do nothing with a bad request', function () {
    ...
    var originalComponent = _lodash2.default.cloneDeep(component);
    var action = {
      type: 'foo'
    };
