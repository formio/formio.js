...
import { checkCondition, fastCloneDeep, firstNonNil, superGet, superSet, uniqueKey, } from '../../utils/utils';
...
var Wizard = /** @class */ (function (_super) {
    ...
    function Wizard() {
        ...
        _this = _super.call(this, element, options, data) || this;
        _this.pages = [];
        _this.prefixComps = [];
        _this.suffixComps = [];
        _this.components = [];
    ...
    Object.defineProperty(Wizard.prototype, "prevPageNum", {
        get: function () {
    ...
    Wizard.prototype.attachHeader = function () {
        ...
        if (this.refs.progressFill) {
            ...
            var finishRate_1 = this.page / (this.pages.length - 1);
            // Animate progress on component render
            setTimeout(function () {
                _this.refs.progressFill.style.width = finishRate_1 * 100 + "%";
            }, 0);
        }
    };
