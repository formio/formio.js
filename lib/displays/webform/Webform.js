...
import { currentTimezone, fastCloneDeep, getStringFromComponentPath, superGet, } from '../../utils/utils';
...
var Webform = /** @class */ (function (_super) {
    ...
    function Webform() {
        ...
        _this_1 = _super.call(this, null, getOptions(options), data) || this;
    ...
    Object.defineProperty(Webform.prototype, "language", {
        ...
        set: function (lang) {
            ...
            return new NativePromise(function (resolve, reject) {
                ...
                try {
                    cleanupThis.i18next.changeLanguage(lang, function (err) {
                        if (err) {
                            cleanupThis = null;
                            return reject(err);
                        }
    ...
    Webform.prototype.localize = function () {
        ...
        return new NativePromise(function (resolve, reject) {
            try {
                ...
                cleanupThis.i18next.init(cleanupThis.options.i18n, function (err) {
                    if (!cleanupThis) {
                    ...
                    var i18next = cleanupThis.i18next;
                    cleanupThis = null;
                    resolve(i18next);
                });
            }
    ...
    Object.defineProperty(Webform.prototype, "ready", {
        ...
        get: function () {
            ...
            return this.formReady.then(function () {
                return superGet(NestedDataComponent, 'ready', _this_1).then(function () {
    ...
    Object.defineProperty(Webform.prototype, "cleanSubmission", {
        get: function () {
            var submission = {
                data: _.clone((this.submission && this.submission.data) || {}),
            };
            eachComponent(this.component.components || [], function (component, path) {
                if (!component.input) {
                    return;
                }
                var persistent = component.persistent;
    ...
    Webform.prototype.setSubmission = function (submission, flags) {
        ...
        flags = __assign(__assign({}, flags), { fromSubmission: _.has(flags, 'fromSubmission') ? flags.fromSubmission : true });
            ...
            if (err) {
                ...
                if (err.messages && err.messages.length) {
                    ...
                    err.messages.forEach(function (_a, index) {
                        ...
                        var text = _this_1.t('alertMessage', { label: component_1.label, message: message });
                        createListItem_1(text, index);
                    });
                }
                else if (err) {
    ...
    Webform.prototype.submitUrl = function (URL, headers) {
        ...
        if (API_URL && settings) {
            Formio.makeStaticRequest(API_URL, settings.method, submission, { headers: settings.headers }).then(function () {
                ...
                _this_1.showErrors((e.statusText ? e.statusText : '') + " " + (e.status ? e.status : e));
                _this_1.emit('error', (e.statusText ? e.statusText : '') + " " + (e.status ? e.status : e));
                console.error((e.statusText ? e.statusText : '') + " " + (e.status ? e.status : e));
                _this_1.setAlert('danger', "<p> " + (e.statusText ? e.statusText : '') + " " + (e.status ? e.status : e) + " </p>");
            });
        }
        else {
