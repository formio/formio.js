...
export class Webform extends NestedDataComponent {
    ...
    setSubmission(submission, flags = {}) {
        flags = Object.assign(Object.assign({}, flags), { fromSubmission: true });
    ...
    setValue(submission, flags = {}) {
        ...
        submission.data = submission.data
            ? Object.assign(Object.assign({}, this.data), submission.data) : this.data;
    ...
    submitForm(options = {}) {
        return new NativePromise((resolve, reject) => {
            ...
            this.hook('beforeSubmit', Object.assign(Object.assign({}, submission), { component: options.component }), (err) => {
                if (err) {
                    return reject(err);
                }
