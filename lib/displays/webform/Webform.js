...
var Webform = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Webform.prototype, "language", {
        ...
        set: function (lang) {
            ...
            return new NativePromise(function (resolve, reject) {
                ...
                if (_this_1.i18next.language === lang) {
                    return resolve();
                }
                try {
                    _this_1.i18next.changeLanguage(lang, function (err) {
                        if (err) {
                            return reject(err);
                        }
                        _this_1.redraw();
    ...
    Webform.prototype.localize = function () {
        ...
        return new NativePromise(function (resolve, reject) {
            try {
                _this_1.i18next.init(_this_1.options.i18n, function (err) {
                    // Get language but remove any ;q=1 that might exist on it.
                    _this_1.options.language = _this_1.i18next.language.split(';')[0];
                    if (err) {
                        return reject(err);
                    }
                    resolve(_this_1.i18next);
                });
            }
            catch (err) {
                return reject(err);
