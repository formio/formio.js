...
import { getIEBrowserVersion, superGet, uniqueName, } from '../../utils/utils';
...
var TextAreaComponent = /** @class */ (function (_super) {
            ...
            switch (_this_1.component.editor) {
                ...
                case 'ckeditor':
                    ...
                    _this_1.addCKE(element, settings, function (newValue) { return _this_1.updateEditorValue(index, newValue); })
                        ...
                        var isReadOnly = _this_1.options.readOnly || _this_1.component.disabled;
    ...
    Object.defineProperty(TextAreaComponent.prototype, "defaultValue", {
        get: function () {
            var defaultValue = superGet(TextFieldComponent, 'defaultValue', this);
