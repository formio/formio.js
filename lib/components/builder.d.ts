...
declare namespace Components {
    export namespace address {
        export { AddressForm as editForm };
    }
    export namespace button {
        export { ButtonForm as editForm };
    }
    export namespace checkbox {
        export { CheckboxForm as editForm };
    }
    export namespace columns {
        export { ColumnsForm as editForm };
    }
    export namespace container {
        export { ContainerForm as editForm };
    }
    export namespace content {
        export { ContentForm as editForm };
    }
    export namespace currency {
        export { CurrencyForm as editForm };
    }
    export namespace datagrid {
        export { DataGridForm as editForm };
    }
    export namespace datamap {
        export { DataMapForm as editForm };
    }
    export namespace datetime {
        export { DateTimeForm as editForm };
    }
    export namespace day {
        export { DayForm as editForm };
    }
    export namespace editgrid {
        export { EditGridForm as editForm };
    }
    export namespace email {
        export { EmailForm as editForm };
    }
    export namespace fieldset {
        export { FieldsetForm as editForm };
    }
    export namespace file {
        export { FileForm as editForm };
    }
    export namespace hidden {
        export { HiddenForm as editForm };
    }
    export namespace htmlelement {
        export { HtmlElementForm as editForm };
    }
    export namespace number {
        export { NumberForm as editForm };
    }
    export namespace panel {
        export { PanelForm as editForm };
    }
    export namespace password {
        export { PasswordForm as editForm };
    }
    export namespace phoneNumber {
        export { PhoneNumberForm as editForm };
    }
    export namespace radio {
        export { RadioForm as editForm };
    }
    ...
    export namespace selectboxes {
        export { SelectboxesForm as editForm };
    }
    export namespace signature {
        export { SignatureForm as editForm };
    }
    export namespace survey {
        export { SurveyForm as editForm };
    }
    export namespace table {
        export { TableForm as editForm };
    }
    export namespace tabs {
        export { TabsForm as editForm };
    }
    export namespace tags {
        export { TagsForm as editForm };
    }
    export namespace textarea {
        export { TextAreaForm as editForm };
    }
    export namespace textfield {
        export { TextfieldForm as editForm };
    }
    export namespace time {
        export { TimeForm as editForm };
    }
    export namespace tree {
        export { TreeForm as editForm };
    }
    export namespace unknown {
        export { UnknownForm as editForm };
    }
    export namespace url {
        export { UrlForm as editForm };
    }
