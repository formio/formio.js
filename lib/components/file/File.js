        ...
        Array.prototype.forEach.call(files, function (file) {
          ...
          if (fileUpload.status !== 'error') {
            ...
            _this6.root.everyComponent(function (element) {
              ...
              if (((_element$component = element.component) === null || _element$component === void 0 ? void 0 : _element$component.submissionAccess) || ((_element$component2 = element.component) === null || _element$component2 === void 0 ? void 0 : _element$component2.defaultPermission)) {
            ...
            var filePromise = fileService.uploadFile(storage, file, fileName, dir, function (evt) {
              ...
              _this6.redraw();
            }, url, options, fileKey, groupPermissions, groupResourceId).then(function (fileInfo) {
