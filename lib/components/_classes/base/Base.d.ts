...
export default class Base {
     ...
     */
    on(event: string, cb: Function, internal?: boolean, once?: boolean): import("eventemitter2").Listener | EventEmitter;
    /**
     ...
     * @param {function} cb - The callback handler to handle this event.
     */
    once(event: string, cb: Function, internal?: boolean): import("eventemitter2").Listener | EventEmitter;
    /**
