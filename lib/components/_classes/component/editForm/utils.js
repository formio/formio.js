...
const EditFormUtils = {
    ...
    logicSectionHandler: {
        ...
        variable({ commonName, property, }) {
            return {
                ...
                components: [
                    Object.assign(Object.assign({}, EditFormUtils.variableSelector()), { key: property }),
                ],
            };
        },
        condition({ commonName, property, }) {
            return {
                ...
                components: [
                    Object.assign(Object.assign({}, EditFormUtils.conditionSelector()), { key: property }),
                ],
            };
        },
    },
    javaScriptValue(title, property, weight, logicSections, additionalParams) {
        return {
            ...
            components: [
                ...
                ...logicSections.map((logicSection) => this.logicSectionHandler[logicSection.type](Object.assign({ commonName: property }, logicSection))),
            ],
        };
    },
    valueDeclaration({ customConditions = null, customVariables = null, excludeConditions = [], excludeValueSources = [], excludeVariables = [], required = true, } = {}) {
        ...
        return [
            ...
            ...valueSources
                ...
                return editForm
                    ? Object.assign(Object.assign({}, editForm), { key: `${valueSource.name}Input`, conditional: {
                            json: {
                                '===': [
                                    {
                                        'var': 'row.valueSource',
    ...
    variableSelector({ customValues = null, exclude = [], } = {}) {
        return {
            type: 'select',
            input: true,
            key: 'variable',
            ...
            data: {
                custom(args) {
                    ...
                    const { editComponentParentInstance = null, } = options;
                    const getDefaultVariables = () => {
                        var _a, _b;
                        let result = ((_a = data.variables) !== null && _a !== void 0 ? _a : []).map((variable) => (Object.assign(Object.assign({}, variable), { group: 'This Component' })));
                        let current = editComponentParentInstance;
                        while (current) {
                            const variables = ((_b = current.variables) !== null && _b !== void 0 ? _b : []).map((variable) => (Object.assign(Object.assign({}, variable), { group: current.parent ? current.label : 'Webform' })));
                    ...
                    return _
                        ...
                        .reject(({ key }) => exclude.some((excludeVariable) => (_.isFunction(excludeVariable)
    ...
    conditionSelector({ customValues = null, exclude = [], } = {}) {
        return {
            type: 'select',
            input: true,
            key: 'condition',
            ...
            data: {
                custom(args) {
                    ...
                    const getDefaultConditions = () => {
                        var _a, _b;
                        let result = ((_a = data.conditions) !== null && _a !== void 0 ? _a : []).map((condition) => (Object.assign(Object.assign({}, condition), { group: 'This Component' })));
                        let current = editComponentParentInstance;
                        while (current) {
                            const conditions = ((_b = current.conditions) !== null && _b !== void 0 ? _b : []).map((condition) => (Object.assign(Object.assign({}, condition), { group: current.parent ? current.label : 'Webform' })));
                    ...
                    return _
                        ...
                        .reject(({ key }) => exclude.some((excludeCondition) => (_.isFunction(excludeCondition)
    ...
    getTransformer({ title, name, arguments: transformerArguments, presetArguments = {}, optionsEditForm, }, { customConditions = null, customVariables = null, excludeValueSources = [], excludeVariables = [], } = {}) {
        const conditional = {
            json: {
                '===': [
                    {
            ...
            ? ([
                {
                    ...
                    components: transformerArguments
                        ...
                        excludeValueSources,
                        excludeVariables: [
                            (key, { instance }) => { var _a, _b, _c, _d; return (key === ((_d = (_c = (_b = (_a = instance === null || instance === void 0 ? void 0 : instance.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.parent) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.key)); },
                            (key, { instance }) => { var _a, _b, _c, _d, _e; return (key === ((_e = (_d = (_c = (_b = (_a = instance === null || instance === void 0 ? void 0 : instance.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.parent) === null || _c === void 0 ? void 0 : _c.parent) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.key)); },
                            (key, { instance }) => { var _a, _b, _c, _d, _e, _f; return (key === ((_f = (_e = (_d = (_c = (_b = (_a = instance === null || instance === void 0 ? void 0 : instance.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.parent) === null || _c === void 0 ? void 0 : _c.parent) === null || _d === void 0 ? void 0 : _d.parent) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.key)); },
                            ...excludeVariables,
                        ],
                    })),
                    conditional,
    ...
    getOperator({ title, name, arguments: operatorArguments, presetArguments = {}, optionsEditForm, }, { customConditions = null, customVariables = null, excludeConditions = [], excludeValueSources = [], } = {}) {
        const conditional = {
            json: {
                '===': [
                    {
    ...
    getArgument({ name, key, required = false, }, { customConditions = null, customVariables = null, excludeConditions = [], excludeValueSources = [], excludeVariables = [], } = {}) {
        return {
            label: name,
            hideLabel: false,
            key,
    ...
    addQuickRule(QuickRule) {
        const { name, title, weight, } = QuickRule;
    ...
    getVariablesEditForm({ customConditions = null, customVariables = null, excludeValueSources = [], } = {}) {
        return {
            label: 'Variables',
            key: 'variables',
            input: true,
            ...
            components: [
                ...
                ...EditFormUtils.valueDeclaration({
                    ...
                    excludeVariables: [
                        (key, { row }) => (key === row.key),
                        (key, { instance }) => { var _a, _b; return (key === ((_b = (_a = instance === null || instance === void 0 ? void 0 : instance.parent) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.key)); },
                        (key, { instance }) => { var _a, _b, _c; return (key === ((_c = (_b = (_a = instance === null || instance === void 0 ? void 0 : instance.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.key)); },
                        (key, { instance }) => { var _a, _b, _c, _d; return (key === ((_d = (_c = (_b = (_a = instance === null || instance === void 0 ? void 0 : instance.parent) === null || _a === void 0 ? void 0 : _a.parent) === null || _b === void 0 ? void 0 : _b.parent) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.key)); },
                    ],
                    excludeValueSources,
                }),
    ...
    getConditionsEditForm({ customConditions = null, customVariables = null, excludeValueSources = [], } = {}) {
        return {
            type: 'editgrid',
            input: true,
            label: 'Conditions',
                ...
                <div class="col-sm-2">
                  ...
                  <button class="btn btn-danger btn-sm removeRow">Delete</button>
                    ...
                    components: [
                        ...
                        Object.assign(Object.assign({}, EditFormUtils.conditionSelector({
    ...
    getWebformLogicEditFormSettings() {
        return {
            customConditions({ data }) {
                var _a, _b;
                return ((_b = (_a = data.settings) === null || _a === void 0 ? void 0 : _a.conditions) !== null && _b !== void 0 ? _b : []).map((condition) => (Object.assign(Object.assign({}, condition), { group: 'Webform' })));
            },
            customVariables({ data }) {
                var _a, _b;
                return ((_b = (_a = data.settings) === null || _a === void 0 ? void 0 : _a.variables) !== null && _b !== void 0 ? _b : []).map((variable) => (Object.assign(Object.assign({}, variable), { group: 'Webform' })));
            },
            excludeValueSources: [
                'thisComponent',
                'thisComponentRow',
