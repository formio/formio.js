...
var EditFormUtils = {
    ...
    getTransformer: function (_a, _b) {
        var title = _a.title, name = _a.name, transformerArguments = _a.arguments, _c = _a.presetArguments, presetArguments = _c === void 0 ? {} : _c, optionsEditForm = _a.optionsEditForm;
        var _d = _b === void 0 ? {} : _b, _e = _d.customConditions, customConditions = _e === void 0 ? null : _e, _f = _d.customVariables, customVariables = _f === void 0 ? null : _f, _g = _d.excludeValueSources, excludeValueSources = _g === void 0 ? [] : _g, _h = _d.excludeVariables, excludeVariables = _h === void 0 ? [] : _h;
        var conditional = {
            json: {
                '===': [
                    {
    ...
    getOperator: function (_a, _b) {
        var title = _a.title, name = _a.name, operatorArguments = _a.arguments, _c = _a.presetArguments, presetArguments = _c === void 0 ? {} : _c, optionsEditForm = _a.optionsEditForm;
        var _d = _b === void 0 ? {} : _b, _e = _d.customConditions, customConditions = _e === void 0 ? null : _e, _f = _d.customVariables, customVariables = _f === void 0 ? null : _f, _g = _d.excludeConditions, excludeConditions = _g === void 0 ? [] : _g, _h = _d.excludeValueSources, excludeValueSources = _h === void 0 ? [] : _h;
        var conditional = {
            json: {
                '===': [
                    {
