...
var EditFormUtils = {
  ...
  javaScriptValue: function javaScriptValue(title, property, propertyJSON, weight, exampleHTML, exampleJSON, additionalParams) {
    return {
      type: 'panel',
      title: title,
      theme: 'default',
      ...
      weight: weight,
      components: [this.logicVariablesTable(additionalParams), {
        type: 'panel',
        title: 'JavaScript',
        collapsible: true,
        collapsed: false,
