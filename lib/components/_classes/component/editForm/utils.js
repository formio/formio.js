...
const EditFormUtils = {
    ...
    getTransformer({ title, name, arguments: transformerArguments, optionsEditForm, }, { customConditions = null, customVariables = null, excludeValueSources = [], excludeVariables = [], } = {}) {
        const conditional = {
            json: {
                '===': [
                    {
    ...
    getOperator({ title, name, arguments: operatorArguments, optionsEditForm, }, { customConditions = null, customVariables = null, excludeConditions = [], excludeValueSources = [], } = {}) {
        const conditional = {
            json: {
                '===': [
                    {
