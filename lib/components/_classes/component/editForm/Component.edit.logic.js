                ...
                components: [
                    {
                        ...
                        components: [
                            ...
                            __assign(__assign({}, EditFormUtils.conditionSelector()), { customConditional: function (_a) {
                                    var row = _a.row;
                ...
                components: [
                    {
                        ...
                        components: [
                            ...
                            __assign(__assign({}, EditFormUtils.variableSelector()), { customConditional: function (_a) {
                                    var row = _a.row;
                                    return row.type === 'value';
                                } }),
                            {
