...
var Component = /*#__PURE__*/function (_Element) {
  ...
  _createClass(Component, [{
    ...
    value: function addQuill(element, settings, onChange) {
      ...
      settings = _lodash.default.merge(this.wysiwygDefault.quill, _lodash.default.get(this.options, 'editors.quill.settings', {}), settings); // Lazy load the quill css.
    ...
    value: function addTiny(element, settings, onChange) {
      return _Formio.default.requireLibrary('tinymce', 'tinymce', TINYMCE_URL.replace('no-api-key', settings.tinyApiKey), true).then(function (editor) {
        return editor.init(_objectSpread({}, settings, {
          target: element,
    ...
    value: function calculateComponentValue(data, flags, row) {
      ...
      if (allowOverride && this.calculatedValue && !_lodash.default.isEqual(dataValue, this.convertNumberOrBoolToString(this.calculatedValue))) {
        return false;
      ...
      if (allowOverride && firstPass && !this.isEmpty(dataValue) && !_lodash.default.isEqual(dataValue, this.convertNumberOrBoolToString(calculatedValue))) {
