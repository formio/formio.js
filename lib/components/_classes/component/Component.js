...
var Component = /*#__PURE__*/function (_Element) {
  ...
  _createClass(Component, [{
    ...
    key: "checkRefreshOn",
    value: function checkRefreshOn(changes, flags) {
      var _this6 = this;
    ...
    value: function redraw() {
      ...
      this.detach(); // Since we are going to replace the element, we need to know it's position so we can find it in the parent's children.
    ...
    value: function calculateComponentValue(data, flags, row) {
      ...
      var normNew = this.normalizeValue(newCalculatedValue); // Check to ensure that the calculated value is different than the previously calculated value.
      ...
      if (_lodash.default.isEqual(normCurr, normNew) && allowOverride) {
        return false;
      }
