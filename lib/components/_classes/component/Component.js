...
export default class Component extends Base {
    ...
    calculateOperator(operator, context = this.logicContext) {
        ...
        return operatorInstance.execute(_.mapValues(args, ({ valueSource, [`${valueSource}Input`]: input, }) => {
            const evaluationContext = {
                valueSource,
                input,
                context: updatedContext,
    ...
    applyTransform(valueEvaluator, transform, context = this.logicContext) {
        ...
        return transformerInstance.transform((Transformer.lazyValueEvaluation ? valueEvaluator : valueEvaluator()), _.mapValues(args, ({ valueSource, [`${valueSource}Input`]: input, }) => {
            const evaluationContext = {
                valueSource,
                input,
                context: updatedContext,
