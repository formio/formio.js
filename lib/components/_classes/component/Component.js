...
var Component = /*#__PURE__*/function (_Element) {
  ...
  _createClass(Component, [{
    ...
    value: function restoreCaretPosition() {
      ...
      if ((_this$root2 = this.root) === null || _this$root2 === void 0 ? void 0 : _this$root2.currentSelection) {
        var _this$refs$input;

        if ((_this$refs$input = this.refs.input) === null || _this$refs$input === void 0 ? void 0 : _this$refs$input.length) {
    ...
    value: function clearOnHide() {
      ...
      (!this.rootPristine || ((_getDataParentCompone = (0, FormioUtils.getDataParentComponent)(this)) === null || _getDataParentCompone === void 0 ? void 0 : _getDataParentCompone.hasScopedChildren)) && this.component.clearOnHide !== false && !this.options.readOnly && !this.options.showHiddenFields) {
        if (!this.visible) {
          this.deleteValue();
    ...
    value: function focus(index) {
      ...
      if ((_this$refs$input2 = this.refs.input) === null || _this$refs$input2 === void 0 ? void 0 : _this$refs$input2.length) {
