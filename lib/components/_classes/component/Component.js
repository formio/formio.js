...
var Component = /** @class */ (function (_super) {
     ...
     * @returns {*}
     */
    Component.prototype.sanitize = function (dirty, forceSanitize) {
    ...
    Component.prototype.setContent = function (element, content, forceSanitize) {
    ...
    Component.prototype.rebuild = function () {
        // Only destroy if there was a previously attached component.
        if (this.attached) {
            this.destroy();
        }
        this.init();
    ...
    Object.defineProperty(Component.prototype, "shouldSanitizeValue", {
        get: function () {
            ...
            return (((_a = this.options) === null || _a === void 0 ? void 0 : _a.sanitize) === false ? true : false);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Component.prototype.checkValidity = function (data, dirty, row, silentCheck) {
        if (data === void 0) { data = this.rootValue; }
        if (dirty === void 0) { dirty = false; }
        if (row === void 0) { row = this.data; }
        if (silentCheck === void 0) { silentCheck = false; }
