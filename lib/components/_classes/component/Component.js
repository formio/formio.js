...
var Component = /** @class */ (function (_super) {
    ...
    function Component(component, options, data) {
        ...
        var _triggerChange = _.debounce(function () {
            ...
            lastChanged = null;
            return _this.onChange.apply(_this, args);
        }, 100);
    ...
    Component.prototype.setOpenModalElement = function () {
        var template = this.getModalPreviewTemplate();
    ...
    Component.prototype.checkRefresh = function (refreshData, changed) {
    ...
    Component.prototype.checkRefreshOn = function (changed) {
        var _this = this;
        ...
        if (refreshOn) {
            if (Array.isArray(refreshOn)) {
                refreshOn.forEach(function (refreshData) {
                    _this.checkRefresh(refreshData, changed);
                });
            }
            else {
    ...
    Component.prototype.getWidgetValueAsString = function (value, options) {
        ...
        if (Array.isArray(value)) {
            ...
            value.forEach(function (val, index) {
                var widget = _this.refs.input[index] && _this.refs.input[index].widge;
                if (widget) {
    ...
    Component.prototype.createModal = function (element, attr) {
        var _this = this;
        ...
        return actions.reduce(function (changed, action) {
            switch (action.type) {
                ...
                case 'value': {
                    ...
                    var newValue = _this.evaluate(action.value, {
    ...
    Component.prototype.addQuill = function (element, settings, onChange) {
        ...
        return Formio.requireLibrary('quill', 'Quill', _.get(this.options, 'editors.quill.src', QUILL_URL + "/quill.min.js"), true)
            ...
            _this.quill = new Quill(element, settings);
    ...
    Component.prototype.addTiny = function (element, settings, onChange) {
        return Formio.requireLibrary('tinymce', 'tinymce', TINYMCE_URL.replace('no-api-key', settings.tinyApiKey), true)
            .then(function (editor) {
            return editor.init(__assign(__assign({}, settings), { target: element, 
                // eslint-disable-next-line camelcase
                init_instance_callback: function (editor) {
                    editor.on('Change', function () { return onChange(editor.getContent()); });
                } }));
        });
    };
    ...
    Component.prototype.calculateOperator = function (operator, context) {
        ...
        return operatorInstance.execute(_.mapValues(args, function (_a) {
    ...
    Component.prototype.applyTransform = function (valueEvaluator, transform, context) {
        ...
        return transformerInstance.transform((Transformer.lazyValueEvaluation ? valueEvaluator : valueEvaluator()), _.mapValues(args, function (_a) {
            var valueSource = _a.valueSource, _b = valueSource + "Input", input = _a[_b];
            var evaluationContext = {
                valueSource: valueSource,
                input: input,
