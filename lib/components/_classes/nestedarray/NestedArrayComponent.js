...
var NestedArrayComponent = /** @class */ (function (_super) {
    ...
    NestedArrayComponent.prototype.checkRows = function (method, data, opts, defaultValue) {
        var _this = this;
        return this.iteratableRows.reduce(function (valid, row) { return _this.checkRow(method, data, opts, row.data, row.components) && valid; }, defaultValue);
    };
    NestedArrayComponent.prototype.checkRow = function (method, data, opts, row, components) {
        return _.reduce(components, function (valid, component) { return component[method](data, opts, row) && valid; }, true);
    };
    ...
    NestedArrayComponent.prototype.getComponent = function (path, fn) {
        if (this.builderMode) {
            return _super.prototype.getComponent.call(this, path, fn);
        }
