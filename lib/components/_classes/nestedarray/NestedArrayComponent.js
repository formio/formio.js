...
export default class NestedArrayComponent extends NestedDataComponent {
    ...
    checkRows(method, data, opts, defaultValue, silentCheck) {
        return this.iteratableRows.reduce((valid, row) => this.checkRow(method, data, opts, row.data, row.components, silentCheck) && valid, defaultValue);
    }
    checkRow(method, data, opts, row, components, silentCheck) {
        return _.reduce(components, (valid, component) => component[method](data, opts, row, silentCheck) && valid, true);
    }
    hasAddButton() {
