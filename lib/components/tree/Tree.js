...
function (_NestedComponent) {
  ...
  _createClass(TreeComponent, [{
    ...
    value: function checkData(data) {
      ...
      return this.tree.children.reduce(function (valid, child) {
        return _this13.checkNode(data, child, flags) && valid;
      }, true);
    }
  }, {
    key: "checkNode",
    value: function checkNode(data, node) {
      ...
      return _get(_getPrototypeOf(TreeComponent.prototype), "checkData", this).call(this, data, flags, node.components);
    }
  }, {
    key: "emptyValue",
    get: function get() {
