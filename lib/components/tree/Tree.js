...
var TreeComponent = /** @class */ (function (_super) {
    ...
    TreeComponent.prototype.destroy = function (all) {
    ...
    TreeComponent.prototype.removeComponents = function (components, all) {
        if (all === void 0) { all = false; }
        return components.map(function (component) { return component.destroy(all); });
    };
