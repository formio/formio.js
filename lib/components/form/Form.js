...
import { getStringFromComponentPath, getArrayFromComponentPath, eachComponent, isMongoId, superGet, } from '../../utils/utils';
...
var FormComponent = /** @class */ (function (_super) {
        ...
        return _super.prototype.attach.call(this, element)
            ...
            return _this.subFormReady.then(function () {
                ...
                if (!_this.builderMode && _this.component.modalEdit) {
                    ...
                    _this.componentModal = new ComponentModal(_this, element, modalShouldBeOpened, currentValue);
    ...
    FormComponent.prototype.setValue = function (submission, flags) {
        ...
        if (this.subForm) {
            if (submission &&
                ...
                var formUrl = submission.form ? this.subForm.formio.formsUrl + "/" + submission.form : this.formSrc;
                var submissionUrl = formUrl + "/submission/" + submission._id;
    ...
    Object.defineProperty(FormComponent.prototype, "errors", {
        get: function () {
            var errors = superGet(Component, 'errors', this);
            if (this.subForm) {
