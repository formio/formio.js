  ...
  _createClass(FormComponent, [{
      ...
      return _get(_getPrototypeOf(FormComponent.prototype), "attach", this).call(this, element).then(function () {
        return _this.subFormReady.then(function () {
          ...
          if (_this.subForm) {
            ...
            if (_this.subForm._form.display === 'wizard' && _this.root._form.display === 'wizard') {
              _this.root.redraw();
            }
    ...
    value: function createSubForm() {
      ...
      this.subFormReady = this.loadSubForm().then(function (form) {
        ...
        if (_this3.root && _this3.root.subWizards && (subForm === null || subForm === void 0 ? void 0 : subForm._form.display) === 'wizard') {
          var _this3$root, _this3$root$subWizard;

          var existedForm = (_this3$root = _this3.root) === null || _this3$root === void 0 ? void 0 : (_this3$root$subWizard = _this3$root.subWizards) === null || _this3$root$subWizard === void 0 ? void 0 : _this3$root$subWizard.findIndex(function (form) {
            return form.component.form === _this3.component.form;
          });

          if (existedForm !== -1) {
            _this3.root.subWizards[existedForm] = _this3;
          } else {
            _this3.root.subWizards.push(_this3);
          }

          _this3.emit('subWizardsUpdated', subForm);
        }
      ...
      if (this.shouldSubmit) {
        return this.subFormReady.then(function () {
          ...
          return _this5.subForm.submitForm().then(function (result) {
            ...
            _this5.subForm.showAllErrors = false;
            _this5.dataValue = result.submission;
            return _this5.dataValue;
          }).catch(function (err) {
            _this5.subForm.showAllErrors = true;
