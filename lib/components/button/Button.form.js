...
exports.default = function () {
  ...
  return _Base2.default.apply(undefined, [[{
    ...
    components: [{
      ...
      data: {
        values: [{ label: 'Submit', value: 'submit' }, { label: 'Save in state', value: 'saveState' }, { label: 'Event', value: 'event' }, { label: 'Custom', value: 'custom' }, { label: 'Reset', value: 'reset' }, { label: 'Delete', value: 'delete' }, { label: 'OAuth', value: 'oauth' }, { label: 'POST to URL', value: 'url' }]
      }
    }, {
      type: 'textfield',
      label: 'Button Event',
