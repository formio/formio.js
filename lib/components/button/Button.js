  ...
  _createClass(ButtonComponent, [{
    ...
    value: function attachButton() {
      ...
      this.on('change', function (value, flags) {
        ...
        var changedRoot = flags === null || flags === void 0 ? void 0 : (_flags$changed = flags.changed) === null || _flags$changed === void 0 ? void 0 : _flags$changed.root; //check root validity only if disableOnInvalid is set and when it is not possible to make submission because of validation errors

        if (flags && flags.noValidate && (_this2.component.disableOnInvalid || _this2.hasError) || _this2.root !== changedRoot) {
