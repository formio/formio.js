...
var ButtonComponent = /** @class */ (function (_super) {
    ...
    ButtonComponent.prototype.attachButton = function () {
        ...
        if (this.component.action === 'submit') {
            ...
            this.on('submitDone', function (message) {
                var resultMessage = message || _this.t('complete');
                _this.loading = false;
            ...
            this.on('submitError', function (message) {
                var resultMessage = message || _this.t(_this.errorMessage('error'));
                _this.loading = false;
                _this.disabled = false;
                _this.hasError = true;
        ...
        this.on('change', function (value, flags) {
            var isValid = (flags && flags.noValidate) ?
                (_this.root ? _this.root.checkValidity(_this.root.data, null, null, true) : true) :
                value.isValid;
            _this.loading = false;
    ...
    ButtonComponent.prototype.openOauth = function () {
        var _this = this;
        if (!this.root.formio) {
        ...
        var interval = setInterval(function () {
            try {
                ...
                if (popup && !popup.closed && popupHost === currentHost && popup.location.search) {
                    ...
                    _this.root.formio.saveSubmission(submission)
