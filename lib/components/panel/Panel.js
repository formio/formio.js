...
var PanelComponent = /** @class */ (function (_super) {
    ...
    PanelComponent.prototype.checkValidity = function (data, dirty, row, silentCheck) {
        var _this = this;
        ...
        return this.getComponents().reduce(function (check, comp) {
            ...
            if (!comp.checkValidity(data, dirty, row, silentCheck) && _this.collapsed) {
                _this.collapsed = false;
            }
            return comp.checkValidity(data, dirty, row, silentCheck) && check;
        }, _super.prototype.checkValidity.call(this, data, dirty, row, silentCheck));
    };
