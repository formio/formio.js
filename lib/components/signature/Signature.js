...
var SignatureComponent = /*#__PURE__*/function (_Input) {
  ...
  _createClass(SignatureComponent, [{
    ...
    key: "changeCanvasDimensions",
    value: function changeCanvasDimensions(force, scale, sizeChanged) {
      var currentWidth = this.currentWidth;
      var canvasAddedWidth = this.refs.canvas.offsetWidth - this.refs.canvas.width;
      var expectedCanvasWidth = currentWidth * this.scale - canvasAddedWidth;
      var isSizeChanged = sizeChanged || false;
