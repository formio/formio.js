...
export default class DateTimeComponent extends Input {
    ...
    constructor(component, options, data) {
        ...
        this.calOptions = Object.assign({ type: 'calendar', altInput: true, timezone, displayInTimezone: _.get(this.component, 'displayInTimezone', 'viewer'), submissionTimezone: this.submissionTimezone, language: this.options.language, useLocaleSettings: _.get(this.component, 'useLocaleSettings', false), allowInput: _.get(this.component, 'allowInput', true), mode: this.component.multiple ? 'multiple' : 'single', enableTime: _.get(this.component, 'enableTime', true), noCalendar: !_.get(this.component, 'enableDate', true), format: this.component.format || DEFAULT_FORMAT, dateFormat: this.component.dataFormat || ISO_8601_FORMAT, hourIncrement: _.get(this.component, 'timePicker.hourStep', 1), minuteIncrement: _.get(this.component, 'timePicker.minuteStep', 5), time_24hr: time24hr, readOnly: this.options.readOnly, minDate: _.get(this.component, 'datePicker.minDate'), disabledDates: _.get(this.component, 'datePicker.disable'), disableWeekends: _.get(this.component, 'datePicker.disableWeekends'), disableWeekdays: _.get(this.component, 'datePicker.disableWeekdays'), disableFunction: _.get(this.component, 'datePicker.disableFunction'), maxDate: _.get(this.component, 'datePicker.maxDate') }, customOptions);
    ...
    attachElement(input, index) {
        ...
        if (this.refs.input[index]) {
            ...
            this.addEventListener(this.calendars[index]._input, 'blur', () => this.calendars[index].setDate(this.calendars[index]._input.value, true, this.calOptions.altFormat));
        }
    }
    /**
