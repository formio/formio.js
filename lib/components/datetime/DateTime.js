...
import { convertFormatToDayjs, getDateSetting, superGet, } from '../../utils/utils';
...
var DateTimeComponent = /** @class */ (function (_super) {
    ...
    DateTimeComponent.prototype.isEqual = function (valueA, valueB) {
        ...
        var format = convertFormatToDayjs(this.component.format);
