...
export default class SelectComponent extends Field {
    ...
    choicesOptions() {
        ...
        return Object.assign({ removeItemButton: this.component.disabled ? false : _.get(this.component, 'removeItemButton', true), itemSelectText: '', classNames: {
    ...
    setErrorClasses(elements, dirty, options) {
        ...
        if (this.choices) {
            super.setErrorClasses([this.choices.containerInner.element], dirty, options);
        }
        else {
            super.setErrorClasses([this.refs.selectContainer], dirty, options);
        }
    }
}
