...
var SelectComponent = /** @class */ (function (_super) {
    ...
    Object.defineProperty(SelectComponent.prototype, "lazyLoad", {
        get: function () {
    ...
    SelectComponent.prototype.itemTemplate = function (data) {
        ...
        if (data && !this.component.template) {
            ...
            var value = (typeof itemLabel === 'string') ? this.t(itemLabel) : itemLabel;
            return this.sanitize(value, this.shouldSanitizeValue);
        }
        if (typeof data === 'string') {
            var value = this.t(data);
            return this.sanitize(value, this.shouldSanitizeValue);
        }
        if (data.data) {
            ...
            this.addEventListener(this.refs.addResource, 'click', function (event) {
                ...
                new Form(formioForm, formUrl, {}).ready
                    ...
                    form.on('submit', function (submission) {
                        ...
                        var value = _this.valueProperty ? _.get(submission, _this.valueProperty) : submission;
                        if (_this.component.multiple) {
                            value = __spreadArrays(_this.dataValue, [value]);
                        }
