...
var SelectComponent = /*#__PURE__*/function (_Field) {
  ...
  _createClass(SelectComponent, [{
    ...
    value: function addOption(value, label) {
      ...
      var option = {
        value: _lodash.default.isObject(value) ? value : _lodash.default.isNull(value) ? this.emptyValue : String(this.normalizeSingleValue(value)),
        label: label
      };
    ...
    value: function normalizeSingleValue(value) {
      ...
      var normalize = {
        ...
        number: function number() {
          var numberValue = Number.parseFloat(this.value);
    ...
    value: function asString(value) {
      ...
      if (Array.isArray(value) && value.some(function (item) {
        return _this8.isBooleanOrNumber(item);
      })) {
        value = value.map(function (item) {
          if (_this8.isBooleanOrNumber(item)) {
            item = item.toString();
          }
        });
      }
