...
describe('Select Component', function () {
  ...
  describe('#setValue', function () {
    ...
    it('should reset input value when called with empty value', function () {
      var comp = Object.assign({}, _fixtures.comp1);
      delete comp.placeholder;
      return _harness.default.testCreate(_Select.default, comp).then(function (component) {
        _powerAssert.default.deepEqual(component.dataValue, {});

        _powerAssert.default.equal(component.inputs[0].value, '');

        component.setValue('red');

        _powerAssert.default.equal(component.dataValue, 'red');

        _powerAssert.default.equal(component.inputs[0].value, 'red');
