...
export default [
    ...
    },
    {
        ...
        components: [
            ...
            Object.assign(Object.assign({}, EditFormUtils.conditionSelector()), { key: 'disabled', label: 'Disabled' }),
        ],
        conditional: {
    ...
    Object.assign(Object.assign({}, EditFormUtils.variableSelector()), { key: 'data.variable', weight: 10, tooltip: 'The variable to be used with this field.', conditional: {
