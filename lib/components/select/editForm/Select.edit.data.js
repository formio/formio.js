...
export default [
    ...
    },
    {
        ...
        components: [
            ...
            __assign(__assign({}, EditFormUtils.conditionSelector()), { key: 'disabled', label: 'Disabled' }),
        ],
        conditional: {
    ...
    __assign(__assign({}, EditFormUtils.variableSelector()), { key: 'data.variable', weight: 10, tooltip: 'The variable to be used with this field.', conditional: {
