...
function (_Webform) {
  ...
  _createClass(PDF, [{
    ...
    value: function attach(element) {
      ...
      return _get(_getPrototypeOf(PDF.prototype), "attach", this).call(this, element).then(function _callee() {
        var iframeSrc, submitButton, form;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 3;
                _context.next = 6;
                return regeneratorRuntime.awrap(_this3.getSrc());

              case 6:
                iframeSrc = _context.sent;
                _context.next = 12;
                break;
    ...
    value: function getSrc() {
      var iframeSrc, params, headers, bodyRequest, htmlBody;
      return regeneratorRuntime.async(function getSrc$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              iframeSrc = "".concat(this._form.settings.pdf.src, ".html");
              params = ["id=".concat(this.id)];
              ...
              _context2.prev = 9;
              _context2.next = 12;
              return regeneratorRuntime.awrap(fetch(iframeSrc, {
                method: 'GET',
            ...
            case 12:
              bodyRequest = _context2.sent;
              _context2.next = 15;
              return regeneratorRuntime.awrap(bodyRequest.text());

            case 15:
              htmlBody = _context2.sent;
              return _context2.abrupt("return", htmlBody);

            case 19:
              _context2.prev = 19;
              _context2.t0 = _context2["catch"](9);
              console.log('error setting pdf iframe', _context2.t0);
              return _context2.abrupt("return", iframeSrc);
