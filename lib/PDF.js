  ...
  _createClass(PDF, [{
    ...
    value: function attach(element) {
      ...
      return _get(_getPrototypeOf(PDF.prototype), "attach", this).call(this, element).then(function _callee() {
        var headers, bodyRequest, htmlBody, iframeWindow, iframeDoc, submitButton, form;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                headers = _this3.options.headers;
                _context.prev = 8;
                _context.next = 11;
    ...
    value: function setSubmission(submission) {
      ...
      return _get(_getPrototypeOf(PDF.prototype), "setSubmission", this).call(this, submission).then(function () {
        if (_this8.formio) {
          console.log('getting submission', _this8.formio.getDownloadUrl);
...
window.addEventListener('message', function (event) {
  ...
  console.log('Formio.forms', _Formio.default.forms); // If this form exists, then emit the event within this form.
