...
var FormBuilder = /*#__PURE__*/function (_Form) {
  ...
  function FormBuilder(element, form, options) {
    ...
    form = form || {};
    options = options || {};
    return _super.call(this, element, form, Object.assign(options, FormBuilder.options, _Formio.default.options && _Formio.default.options.builder ? _Formio.default.options.builder : {}));
  }
