...
export class ListValueSource extends ValueSource {
    ...
    getValue(input) {
        return input.map(({ valueSource, [`${valueSource}Input`]: valueSourceInput, }) => this.targetComponentInstance.calculateValueDefinition(valueSource, valueSourceInput, this.context));
    }
}
