...
const indexTypes = [
    ...
    VariableValueSource,
].reduce((result, indexType) => (Object.assign(Object.assign({}, result), { [indexType.name]: indexType })), {});
...
export class ComponentByPathValueSource extends ValueSource {
    ...
    static getInputEditForm(options) {
        return {
            ...
            components: [
                ...
                ...commonIndexSources.map((indexSource) => (Object.assign(Object.assign({}, indexSource.getInputEditForm(options)), { key: `${indexSource.name}Index`, conditional: {
                        json: {
                            '===': [
                                {
                                    var: 'row.indexType',
    ...
    getValue(input) {
        ...
        const component = input.reduce((context, pathPart) => {
            ...
            const { component, indexType, [`${indexType}Index`]: indexInput, } = pathPart;
            ...
            if (indexType) {
                ...
                const indexTypeInstance = new IndexType(Object.assign(Object.assign({}, this.context), { options: Object.assign(Object.assign({}, this.options), { pathForRowIndex }) }));
