...
export default class WebformBuilder extends Component {
    ...
    saveComponent(component, parent, isNew, original) {
        ...
        if (index !== -1) {
            ...
            return rebuild.then(() => {
                ...
                this.emit('saveComponent', schema, originalComp, parentComponent.schema, path, index, isNew, originalComponentSchema);
                this.emit('change', this.form);
    ...
    editBuildingForm(isJsonEdit) {
        ...
        this.editForm = new Webform(Object.assign(Object.assign(Object.assign({}, _.omit(this.options, ['hooks', 'builder', 'events', 'attachMode', 'skipInit'])), { language: this.options.language }), editFormOptions));
    ...
    editComponent(component, parent, isNew, isJsonEdit, original) {
        ...
        if (!isJsonEdit && (!ComponentClass.builderInfo.hasOwnProperty('preview') || ComponentClass.builderInfo.preview)) {
            this.sidebarForm = new Webform(_.omit(Object.assign(Object.assign({}, this.options), { preview: true }), [
                'hooks',
                'builder',
                'events',
                'attachMode',
                ...
                components: [
                    {
                        ...
                        type: 'tabs',
                        hideHeader: true,
                        components: this.editForm.form.components[0].components.map(({ label, key, sidebar, }) => ({
                            label,
                            key,
                            components: (sidebar !== null && sidebar !== void 0 ? sidebar : []).map((component) => (_.isFunction(component) ? component(schema) : component)),
                        })),
                    },
                ],
            };
...
WebformBuilder.editForm = WebformEditForm;
