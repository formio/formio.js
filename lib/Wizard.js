...
var Wizard = /*#__PURE__*/function (_Webform) {
  ...
  _createClass(Wizard, [{
    ...
    value: function init() {
      ...
      this.on('subWizardsUpdated', function () {
        if (_this3.subWizards.length) {
    ...
    value: function transformPages() {
      ...
      var getAllComponents = function getAllComponents(nestedComp, compsArr) {
        ...
        var nestedPages = [];
        var currentComponents = (nestedComp === null || nestedComp === void 0 ? void 0 : nestedComp.subForm) ? _this12.getSortedComponents(nestedComp.subForm) : (nestedComp === null || nestedComp === void 0 ? void 0 : nestedComp.components) || [];
        var additionalComponents = currentComponents.filter(function (comp) {
          return !comp.subForm && comp._visible;
        });
        var hasNested = false;
        (0, _utils.eachComponent)(currentComponents, function (comp) {
      ...
      if (this.originalComponents) {
        this.originalComponents.forEach(function (item) {
          if (item.type === 'panel') {
            ...
            var isVisible = (0, _utils.checkCondition)(item, data, data, _this13.component, _this13);
    ...
    value: function redraw() {
      ...
      if ((_this$parent = this.parent) === null || _this$parent === void 0 ? void 0 : (_this$parent$componen = _this$parent.component) === null || _this$parent$componen === void 0 ? void 0 : _this$parent$componen.modalEdit) {
    ...
    key: "hasExtraPages",
    get: function get() {
      return !_lodash.default.isEmpty(this.subWizards) && !_lodash.default.isEqual(this.pages, this.components);
    }
  }, {
    key: "data",
    get: function get() {
    ...
    get: function get() {
      ...
      return {
        ...
        isSubForm: !!this.parent && !((_this$root = this.root) === null || _this$root === void 0 ? void 0 : (_this$root$component = _this$root.component) === null || _this$root$component === void 0 ? void 0 : _this$root$component.type) === 'wizard',
