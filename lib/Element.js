...
var Element = /** @class */ (function () {
     ...
     */
    Element.prototype.addEventListener = function (obj, type, func, persistent) {
        if (!obj) {
            return;
        }
        if (!persistent) {
     ...
     */
    Element.prototype.setInputMask = function (input, inputMask, placeholder) {
        if (input && inputMask) {
     ...
     */
    Element.prototype.t = function (text, params) {
        params = params || {};
        params.nsSeparator = '::';
        params.keySeparator = '.|.';
     ...
     */
    Element.prototype.interpolate = function (string, data) {
