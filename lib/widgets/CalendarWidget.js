...
import { convertFormatToFlatpickr, convertFormatToMask, convertFormatToDayjs, currentTimezone, formatDate, formatOffset, getDateSetting, getLocaleDateFormatInfo, dayjsDate, superGet, superSet, } from '../utils/utils';
    ...
    CalendarWidget.prototype.attach = function (input) {
        ...
        this.settings.formatDate = function (date, format) {
            ...
            if (_this.settings.readOnly && (format === _this.settings.altFormat)) {
                if (_this.settings.saveAs === 'text' || !_this.settings.enableTime) {
