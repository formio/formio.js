...
import { convertFormatToFlatpickr, convertFormatToMask, convertFormatToMoment, currentTimezone, formatDate, formatOffset, getDateSetting, getLocaleDateFormatInfo, momentDate, zonesLoaded, shouldLoadZones, loadZones } from '../utils/utils';
...
var CalendarWidget = /** @class */ (function (_super) {
    ...
    CalendarWidget.prototype.attach = function (input) {
        ...
        this.settings.onChange = function () { return _this.emit('update'); };
