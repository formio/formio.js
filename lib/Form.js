...
var Form = /** @class */ (function (_super) {
     ...
     * @return {*}
     */
    Form.prototype.create = function (display, incomingSubmission) {
        if (this.options && (this.options.flatten || this.options.renderMode === 'flat')) {
            display = 'form';
        }
        this.display = display;
        if (Displays.displays[display]) {
            return new Displays.displays[display](this.element, this.options, incomingSubmission === null || incomingSubmission === void 0 ? void 0 : incomingSubmission.data);
        }
        else {
            // eslint-disable-next-line new-cap
            return new Displays.displays['webform'](this.element, this.options, incomingSubmission === null || incomingSubmission === void 0 ? void 0 : incomingSubmission.data);
        }
    };
    ...
    Form.prototype.setForm = function (formParam, incomingSubmission) {
        var _this = this;
        var result;
        ...
        if (typeof formParam === 'string') {
            ...
            result = this.getSubmission(formio_1)
                ...
                return formio_1.loadForm()
                    ...
                    _this.instance = _this.instance || _this.create(form.display, submission || incomingSubmission);
                    ...
                    if (submission || incomingSubmission) {
                        _this.instance.submission = submission || incomingSubmission;
                    }
                    if (error_1) {
                        throw error_1;
                    }
