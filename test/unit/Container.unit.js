...
import { comp1, comp2, comp3, comp4 } from './fixtures/container/index';
...
describe('Container Component', function () {
  ...
  describe('Container component calculations when noDefaults Form Renderer Option', function () {
    const formTemplate = {
    ...
    it('Should set correct form data and make correct container component calculations when noDefaults Form Renderer Option is set', async function () {
      const element = document.createElement('div');
    ...
    it('Should set correct form data and make correct container component calculations when noDefaults Form Renderer Option is not set', async function () {
      const element = document.createElement('div');
