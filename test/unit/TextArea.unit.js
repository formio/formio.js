...
import { comp1, comp2, comp3, comp4, comp5 } from './fixtures/textarea/index';
...
describe('TextArea Component', function () {
  ...
  it('Should translate character counter if it is enabled', function (done) {
    const form = _.cloneDeep(comp3);
    form.components[0].showCharCount = true;
  ...
  describe('Rich text editors', function () {
    describe('CKEditor', function () {
      ...
      it('File upload plugin should be constructor', function (done) {
        try {
    ...
    it('Should set array as value for textarea with ace editor with json data type', function (done) {
      const element = document.createElement('div');
