...
const stringValues = {
  ...
  textArea: 'test value',
  number: '280',
  password: process.env.USER_PASSWORD || 'defaultPassword', // 수정된 부분
  checkbox: 'Yes',
  selectBoxes: 'a, c',
  select: '<span>A</span>',
  radio: 'b',
